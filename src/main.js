...
axios.defaults.baseURL = 'http://192.168.100.23:5006/' /*'http://192.168.100.23:44313/'*/ /*'https://pccentenario.pgjhidalgo.gob.mx/'*/

//const keycloakUser = axios.create({ baseURL: 'https://login-admin.pgjhidalgo.gob.mx/'})
//Vue.prototype.$keycloakUser = keycloakUser

const jrInstance = axios.create({ baseURL: 'http://192.168.100.23:44309/' /*'https://jrcentenario.pgjhidalgo.gob.mx/'*/ }) 
Vue.prototype.$jr = jrInstance 

const controlaccesoInstance = axios.create({ baseURL: 'http://192.168.100.23:44321/' /*'https://controlaccesocentenario.pgjhidalgo.gob.mx/'*/ })
Vue.prototype.$controlacceso = controlaccesoInstance 

const confInstance = axios.create({baseURL: 'http://192.168.100.23:44360/' /*'https://configuracioncentenario.pgjhidalgo.gob.mx/'*/ })
Vue.prototype.$conf = confInstance

const catInstance = axios.create({baseURL: 'http://192.168.100.23:44394/' /*'https://catcentenario.pgjhidalgo.gob.mx/'*/ })
Vue.prototype.$cat = catInstance

const CATInstance = axios.create({baseURL: 'http://192.168.100.23:44394/' /*'https://catcentenario.pgjhidalgo.gob.mx/'*/ }) 
Vue.prototype.$CAT = CATInstance

const SPInstance = axios.create({baseURL: 'http://192.168.100.23:5008/' /*'http://192.168.100.23:44336/'*/ /*'https://spcentenario.pgjhidalgo.gob.mx/'*/ })
Vue.prototype.$SP = SPInstance

const panelInstance = axios.create({baseURL: 'http://192.168.100.23:5006/' /*'http://192.168.100.23:44313/'*/ /*'https://pccentenario.pgjhidalgo.gob.mx/'*/ })
Vue.prototype.$panel = panelInstance

const justiciarestaurativaInstance = axios.create({baseURL: 'http://192.168.100.23:44309/' /*'https://jrcentenario.pgjhidalgo.gob.mx/'*/ })
Vue.prototype.$justiciarestaurativa = justiciarestaurativaInstance

const ILInstance = axios.create({baseURL:  'http://192.168.100.23:44312/' /*'https://ilcentenario.pgjhidalgo.gob.mx/'*/ })
Vue.prototype.$IL = ILInstance

const PIInstance = axios.create({baseURL: 'http://192.168.100.23:5007/' /*'http://192.168.100.23:44315/'*/ /*'https://picentenario.pgjhidalgo.gob.mx/'*/ }) 
