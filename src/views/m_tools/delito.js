...
export default {
  ...
  data () {
    return {
      ...
      headers: [
        { text: 'Delito', value: 'usuario', sortable: true  },
        { text: 'Delito Específico', value: 'modulo', sortable: true  },
        { text: 'Tipo Fuero', value: 'nombrePersona', sortable: true  },
        { text: 'Fecha',value: 'tipoEA' },
        { text: 'Tipo Declaración',value: 'entrevistaInicial' },
        { text: 'Intensión',value: 'intensionDelito' },
  ...
  methods: {
    ...
    listar(){
      ...
      let header={"Authorization" : "Bearer " + this.$store.state.token};
        ...
        me.$CAT.get('api/RDHs/ListarPorHecho/'+ me.infoCarpeta.rHechoId,configuracion).then(function(response){
