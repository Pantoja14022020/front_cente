  ...
  <v-layout align-start>
    ...
    <v-flex v-if="showpage">
      <v-toolbar flat color="white">
        ...
        <v-toolbar-title class="font-weight-regular" >Personas asignadas en Carpeta</v-toolbar-title>
          ...
          <td class="justify-center layout px-0">
            <v-tooltip bottom>
              <template v-slot:activator="{ on }">
                <v-icon class="mr-2" color="error" v-on="on" @click="mostrarFormularioModificacion(props.item,{title:'Borrar Persona',icon:'delete_forever',color:'red',operation:'Raps/Eliminar',buttonText:'Borrar',extraComponents:{}},'CAT_RAP,CAT_PERSONA')">
                  delete_forever
                </v-icon>
              </template>
            ...
            <v-tooltip bottom>
              <template v-slot:activator="{ on }">
                <v-icon class="mr-2" color="#36abeb" v-on="on" @click="mostrarFormularioModificacion(props.item,{title:'Definir como Persona Inicial',icon:'check',color:'#36abeb',operation:'Raps/SetPersonaInicial',buttonText:'Actualizar',extraComponents:{}},'CAT_RAP')">
                  check
                </v-icon>
              </template>
              <span> Definir como Persona Inicial</span>
            </v-tooltip>
          </td>
        </template>
