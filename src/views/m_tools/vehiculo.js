  ...
  data () {
    return {
      ...
      headers: [
        ...
        { text: 'Propiertario', value: 'propietario', sortable: true  },
        { text: 'Fecha', value: 'fechaRegistro', sortable: true  },
        { text: 'Robado', value: 'estadoRobado', sortable: true  },
  ...
  methods: {
    ...
    listar(){
      ...
      let header={"Authorization" : "Bearer " + this.$store.state.token};
        ...
        me.$CAT.get('api/Vehiculos/Listar/'+ me.infoCarpeta.rHechoId,configuracion).then(function(response){
