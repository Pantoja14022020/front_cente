  ...
  data () {
    return {
      ...
      headers: [
        ...
        { text: 'Distrito', value: 'agentequerecibe', sortable: true  },
        { text: 'Sub Procuraduría', value: 'razonDescripcion', sortable: true  },
  ...
  methods: {
    ...
    listar(){
      ...
      let header={"Authorization" : "Bearer " + this.$store.state.token};
        ...
        me.$CAT.get('api/Oficios/Listar/'+ me.infoCarpeta.rHechoId,configuracion).then(function(response){
