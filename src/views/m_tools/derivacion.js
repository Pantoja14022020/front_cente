  ...
  data () {
    return {
      ...
      headers: [
        ...
        { text: 'Número de Expediente', value: 'noExpediente', sortable: false  },
        { text: 'Sede', value: 'sede', sortable: false },
        { text: 'Año', value: 'año', sortable: false  },
        { text: 'Fecha Derivación', value: 'fechaDerivacion', sortable: false  },
        { text: 'Estatus',value: 'statusAcepRech', sortable: false },
    ...
    listar(){
      ...
      let header={"Authorization" : "Bearer " + this.$store.state.token};
        let configuracion= {headers : header};
            me.$jr.get('api/Expedientes/ListarPorHecho/'+ me.infoCarpeta.rHechoId,configuracion).then(function(response){
