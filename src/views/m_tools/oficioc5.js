  ...
  data () {
    return {
      ...
      headers: [
        ...
        { text: 'Agente que recibe', value: 'agentequerecibe', sortable: true  },
        { text: 'Descripción Razón', value: 'razonDescripcion', sortable: true  },
        { text: 'Insumos', value: 'insumos', sortable: true  },
        { text: 'Fecha',value: 'fechaSys' },
  ...
  methods: {
    ...
    listar(){
      ...
      let header={"Authorization" : "Bearer " + this.$store.state.token};
        ...
        me.$CAT.get('api/C5i/Listar/'+ me.infoCarpeta.rHechoId,configuracion).then(function(response){
