  ...
  data () {
    return {
      ...
      headers: [
        ...
        { text: 'Clasificación', value: 'clasificacionPersona', sortable: true  },
        { text: 'Inicial', value: 'nombrePersona', sortable: true  },
        { text: 'Edad',value: 'edad' },
        { text: 'CURP', value: 'curp', sortable: false },
        { text: 'Opciones',value: 'entrevistaInicial' }
    ],
  ...
  methods: {
    ...
    mostrarFormularioModificacion (item,info,tablas) 
    {
      ...
      this.$refs.formModificacion.mostrar({
            'rHechoId':"00000000-0000-0000-0000-000000000000" ,
            'rAtencionId':  item.rAtencionId,
            'registroId':item.idRAP
          },
          info
          );
    },
