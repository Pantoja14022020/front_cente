...
export default {
  ...
  data () {
    return {
      ...
      headers: [
        { text: 'Oficio', value: 'numeroOficio', sortable: true  },
        { text: 'Fecha Solicitud', value: 'fechaSolicitud', sortable: true  },
        { text: 'No de Solicitud', value: 'nodeSolicitud', sortable: true  },
        { text: 'Usuario', value: 'uUsuario', sortable: true  },
  ...
  methods: {
    ...
    listar(){
      ...
      let header={"Authorization" : "Bearer " + this.$store.state.token};
        let configuracion= {headers : header};
            me.$CAT.get('api/RActosInvestigacion/Listarporid/'+ me.infoCarpeta.rHechoId,configuracion).then(function(response){
    ...
    mostrarFormularioModificacion (item,info,tablas) 
    {
      ...
      this.$refs.formModificacion.mostrar({
                                                  ...
                                                  'registroId':item.idRActosInvestigacion
                                                },
                                          info
                                          );
    },
