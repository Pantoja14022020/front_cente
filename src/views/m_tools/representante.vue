  ...
  <v-layout align-start>
    ...
    <v-flex v-if="showpage">
      <v-toolbar flat color="white">
        ...
        <v-toolbar-title class="font-weight-regular" >Lista de Representantes en Carpeta</v-toolbar-title>
      ...
      >
        <template slot="items" class="white" slot-scope="props">
          ...
          <td>{{ props.item.tipoRep1+'/'+props.item.tipoRep2 }}</td>
          <td class="justify-center layout px-0">
            <v-tooltip bottom>
              <template v-slot:activator="{ on }">
                <v-icon class="mr-2" color="error" v-on="on" @click="mostrarFormularioModificacion(props.item,{title:'Borrar Representante',icon:'delete_forever',color:'red',operation:'Representante/Eliminar',buttonText:'Borrar',extraComponents:{}},'CAT_REPRESENTANTES,CAT_DOCSREPRESENTANTES')">
                  delete_forever
                </v-icon>
              </template>
