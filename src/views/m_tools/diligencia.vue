  ...
  <v-layout align-start>
    ...
    <v-flex v-if="showpage">
      <v-toolbar flat color="white">
        ...
        <v-toolbar-title class="font-weight-regular" >Lista de Deligencias en Carpeta</v-toolbar-title>
          ...
          <td class="justify-center layout px-0">
            <v-tooltip bottom>
              <template v-slot:activator="{ on }">
                <v-icon class="mr-2" color="error" v-on="on" @click="mostrarFormularioModificacion(props.item,{title:'Borrar Diligencia',icon:'delete_forever',color:'red',operation:'RDiligencias/Eliminar',buttonText:'Borrar',extraComponents:{}})">
                  delete_forever
                </v-icon>
              </template>
              <span>Eliminar Diligencia</span>
            </v-tooltip>
