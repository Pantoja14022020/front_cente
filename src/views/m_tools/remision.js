  ...
  data () {
    return {
      ...
      headers: [
        ...
        { text: 'Distrito', value: 'agentequerecibe', sortable: false  },
        { text: 'Sub Procuraduría', value: 'razonDescripcion', sortable: false },
        { text: 'Agencia', value: 'uAgencia', sortable: false  },
        { text: 'Módulo', value: 'uModulo', sortable: false  },
  ...
  methods: {
    ...
    listar(){
      ...
      let header={"Authorization" : "Bearer " + this.$store.state.token};
        ...
        me.$CAT.get('api/RemisionesUI/ListarConOrden/'+ me.infoCarpeta.rHechoId,configuracion).then(function(response){
