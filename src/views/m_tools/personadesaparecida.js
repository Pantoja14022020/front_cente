...
export default {
  ...
  data () {
    return {
      ...
      headers: [
        { text: 'Persona Desaparecida', value: 'personaDesap', sortable: true  },
        { text: 'Estado de Salud', value: 'estadoSalud', sortable: true  },
        { text: 'Padecimientos', value: 'padecimiento', sortable: true  },
        { text: 'Etnia', value: 'etnia', sortable: true  },
        { text: 'Grupo Delictivo', value: 'grupoDelictivo', sortable: true  },
        { text: 'Ultimo Avistamiento', value: 'fechaHoraUltAvistamiento', sortable: true  },
  ...
  methods: {
    ...
    {
      this.infoMod.tablaAMod='CAT_PERSONADESAPARECIDA,CAT_VEHICULO_DESAPARICIONPERSONA';
      this.$refs.formModificacion.mostrar({
                                                  'rHechoId':item.rHechoId,
                                                  'rAtencionId':"00000000-0000-0000-0000-000000000000",
                                                  'registroId':item.idPersonaDesaparecida
                                                },
                                          info
                                          );
    },
