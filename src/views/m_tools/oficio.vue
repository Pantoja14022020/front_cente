  ...
  <v-layout align-start>
    ...
    <v-flex v-if="showpage">
      <v-toolbar flat color="white">
        ...
        <v-toolbar-title class="font-weight-regular" >Lista de Oficios en Carpeta</v-toolbar-title>
          ...
          <td class="justify-center layout px-0">
            <v-tooltip bottom>
              <template v-slot:activator="{ on }">
                <v-icon class="mr-2" color="error" v-on="on" @click="mostrarFormularioModificacion(props.item,{title:'Borrar Oficio',icon:'delete_forever',color:'red',operation:'Oficios/Eliminar',buttonText:'Borrar',extraComponents:{}},'CAT_OFICIO')">
                  delete_forever
                </v-icon>
              </template>
