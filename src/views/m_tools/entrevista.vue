  ...
  <v-layout align-start>
    ...
    <v-flex v-if="showpage">
      <v-toolbar flat color="white">
        ...
        <v-toolbar-title class="font-weight-regular" >Lista de Entrevistas en Carpeta</v-toolbar-title>
          ...
          <td class="justify-center layout px-0">
            <v-tooltip bottom>
              <template v-slot:activator="{ on }">
                <v-icon class="mr-2" color="error" v-on="on" @click="mostrarFormularioModificacion(props.item,{title:'Borrar Entrevista',icon:'delete_forever',color:'red',operation:'AmpDecs/Eliminar',buttonText:'Borrar',extraComponents:{}})">
                  delete_forever
                </v-icon>
              </template>
              <span>Eliminar Entrevista</span>
            </v-tooltip>
            <v-tooltip bottom>
              <template v-slot:activator="{ on }">
                <v-icon class="mr-2" color="#36abeb" v-on="on" @click="mostrarFormularioModificacion(props.item,{title:'Definir Entrevista Inicial',icon:'check',color:'#36abeb',operation:'AmpDecs/SetEntrevistaInicial',buttonText:'Guardar',extraComponents:{}})">
                  check
                </v-icon>
              </template>
              <span> Definir como Entrevista Inicial</span>
            </v-tooltip>
