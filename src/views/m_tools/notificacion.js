...
export default {
  ...
  data () {
    return {
      ...
      headers: [
        { text: 'Nombre', value: 'nombrePersona', sortable: true  },
        { text: 'Domicilio', value: 'domicilioPersona', sortable: true  },
        { text: 'Lugar Cita', value: 'lugarCita', sortable: true  },
  ...
  methods: {
    ...
    listar(){
      ...
      let header={"Authorization" : "Bearer " + this.$store.state.token};
        ...
        me.$CAT.get('api/Citatorio_Notificacion/ListarAmbas/'+ me.infoCarpeta.rHechoId,configuracion).then(function(response){
