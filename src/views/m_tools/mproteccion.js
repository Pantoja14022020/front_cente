...
export default {
  ...
  data () {
    return {
      ...
      headers: [
        { text: 'Victima', value: 'voctima', sortable: true  },
        { text: 'Imputado', value: 'imputado', sortable: true  },
        { text: 'Delito', value: 'delito', sortable: true  },
        { text: 'Fecha de Inicio', value: 'fInicio', sortable: true  },
        { text: 'Fecha de Vencimiento', value: 'fVencimiento', sortable: true  },
        
        { text: 'Número de Oficio', value: 'numeroOficio', sortable: true  },
        { text: 'Medida de Protección', value: 'medidaProtecion', sortable: true  },
        { text: 'Duración', value: 'duracion', sortable: true  },
  ...
  methods: {
    ...
    listar(){
      ...
      let header={"Authorization" : "Bearer " + this.$store.state.token};
        ...
        me.$CAT.get('api/MedidasProteccion/Listar/'+ me.infoCarpeta.rHechoId,configuracion).then(function(response){
