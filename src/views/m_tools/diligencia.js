  ...
  data () {
    return {
      ...
      headers: [
        ...
        { text: 'Emitido Por', value: 'emitidoPor', sortable: true  },
        { text: 'Fecha de Solicitud', value: 'fechaSolicitud', sortable: true  },
        { text: 'Dirigido a:', value: 'dirigidoa', sortable: true  },
        { text: 'Número de Oficio',value: 'numeroOficio' },
        { text: 'Número de Solicitud',value: 'nodeSolicitud' },
  ...
  methods: {
    ...
    listar(){
      ...
      let header={"Authorization" : "Bearer " + this.$store.state.token};
        ...
        me.$CAT.get('api/RDiligencias/Listar/'+ me.infoCarpeta.rHechoId,configuracion).then(function(response){
