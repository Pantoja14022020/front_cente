  ...
  <v-layout align-start>
    ...
    <v-flex v-if="showpage">
      <v-toolbar flat color="white">
        ...
        <v-toolbar-title class="font-weight-regular" >Lista de Citatorios/Notificaciones en Carpeta</v-toolbar-title>
          ...
          <td class="justify-center layout px-0">
            <v-tooltip bottom>
              <template v-slot:activator="{ on }">
                <v-icon class="mr-2" color="error" v-on="on" @click="mostrarFormularioModificacion(props.item,{title:'Borrar Citatorio/Notificacion',icon:'delete_forever',color:'red',operation:'Citatorio_Notificacion/Eliminar',buttonText:'Borrar',extraComponents:{}})">
                  delete_forever
                </v-icon>
              </template>
              <span>Eliminar Citatorio/Notificacion</span>
            </v-tooltip>
