...
export default {
  ...
  data () {
    return {
      ...
      headers: [
        { text: 'Representante', value: 'nombres', sortable: true  },
        { text: 'Representado', value: 'personaR', sortable: true  },
        { text: 'CURP', value: 'curp', sortable: true  },
        { text: 'Telefono', value: 'telefono', sortable: true  },
        { text: 'Correo', value: 'correoElectronico', sortable: true  },
        { text: 'Cédula', value: 'tipoDocumento', sortable: true  },
        { text: 'Tipo Rep.', value: 'tipoDocumento', sortable: true  },
  ...
  methods: {
    ...
    listar(){
      ...
      let header={"Authorization" : "Bearer " + this.$store.state.token};
        ...
        me.$CAT.get('api/Representante/Representanteslistarporid/'+ me.infoCarpeta.rHechoId,configuracion).then(function(response){
    ...
    mostrarFormularioModificacion (item,info,tablas) 
    {
      ...
      this.$refs.formModificacion.mostrar({
                                                  ...
                                                  'registroId':item.idRepresentante
                                                },
                                          info
                                          );
    },
