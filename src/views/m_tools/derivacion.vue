  ...
  <v-layout align-start>
    ...
    <v-flex v-if="showpage">
      <v-toolbar flat color="white">
        ...
        <v-toolbar-title class="font-weight-regular" >Lista de Derivaciones a Justicia Restaurativa de la Carpeta</v-toolbar-title>
          ...
          <td  class="justify-center layout px-0">
            <v-tooltip bottom>
              <template v-slot:activator="{ on }">
                <v-icon class="mr-2" color="error" v-on="on" @click="mostrarFormularioModificacion(props.item,{title:'Borrar Derivación',icon:'delete_forever',color:'red',operation:'Expedientes/Eliminar',buttonText:'Borrar',extraComponents:{}},'CAT_REMISIONUI,CAT_RHECHO')">
                  delete_forever
                </v-icon>
              </template>
