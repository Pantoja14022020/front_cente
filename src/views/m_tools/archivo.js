  ...
  data () {
    return {
      ...
      headers: [
        ...
        { text: 'Tipo', value: 'tipoDocumento', sortable: true  },
        { text: 'Distrito', value: 'uDistrito', sortable: true  },
  ...
  methods: {
    ...
    listar(){
      ...
      let header={"Authorization" : "Bearer " + this.$store.state.token};
        ...
        me.$CAT.get('api/Archivos/Listar/'+ me.infoCarpeta.rHechoId,configuracion).then(function(response){
