  ...
  methods: {
    ...
    listar(){
      ...
      let header={"Authorization" : "Bearer " + this.$store.state.token};
        ...
        me.$CAT.get('api/AmpDecs/Listar/'+ me.infoCarpeta.rHechoId,configuracion).then(function(response){
    ...
    mostrarFormularioModificacion (item,info) 
    {
      ...
      console.log(item);
      this.infoMod.tablaAMod='CAT_AMPDEC';
      this.$refs.formModificacion.mostrar({
                                                  'rHechoId':item.hechoId,
                                                  'rAtencionId':"00000000-0000-0000-0000-000000000000",
                                                  'registroId':item.idAmpliacion
                                                },
                                          info
                                          );
    },
