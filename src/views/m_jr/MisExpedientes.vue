<template>
   ...
   <v-flex v-if="showpage">
    <v-toolbar flat color="white">
            <v-toolbar-title class="font-weight-regular" >Mis expedientes.</v-toolbar-title>
            ...
            <v-spacer></v-spacer>
             ...
             <v-tooltip   bottom   >
                <template  v-slot:activator="{ on }">
                     <v-btn  v-if="u_rol=='Facilitador'"  class="mx-2" slot="activator" v-on="on" @click.native="modalExp=true" fab dark small color="prymary">
                     <v-icon dark> 
                        open_in_new
                     </v-icon>
...
<v-dialog   v-model="modalExp"  max-width="700px"> 
                    ...
                    <v-toolbar-title class="subheading">Abrir expediente</v-toolbar-title>
                    <v-spacer></v-spacer>
                        ...
                        <v-form ref="form">
                            <v-container grid-list-md>
                                ...
                                <v-flex xs12 sm12 md12>
                                   <a>Ingresa el número de expediente.</a>
                                    <br> 
                                    <v-text-field
                            ...
                            <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-btn  @click.native="modalExp=false" >Cancelar</v-btn>
                                <v-btn @click.native="openExpFull()" class="success" >Abrir expediente</v-btn>
                            </v-card-actions>
                        </v-form>
  ...
  export default {
    ...
    methods:{ 
        ...
        { 
            ...
            this.$router.push('./informacionexpediente') 
        }, 
