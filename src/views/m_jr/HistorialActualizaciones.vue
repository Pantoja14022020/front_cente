      ...
      return this.$store.state.drawer
        ...
        { 
            ...
            listarActualizaciones()
            {
                ...
                {
                    me.$cat.get('api/Actualizaciones/Listar',configuracion).then(function(response)
                    {
                ...
                else
                {
                    ...
                    me.$cat.get('api/Actualizaciones/ListarUsuarios/' + me.moduloCentenario ,configuracion).then(function(response)
                    {
                        me.actualizaciones = response.data;
                ...
                me.$validator.validate().then(result => {
                    if (result) 
                    {
                        ...
                        if (me.imageFile) 
                        {
                            ...
                            me.$cat.post('api/Actualizaciones/SubirPdfAct/' + me.claveActualizacion + '/' + me.GUID, formData, 
                            {
                                headers: {
            ...
            guardarActualizacion()
            {
                ...
                {
                    me.$cat.post('api/Actualizaciones/CrearActualizacion', 
                    {
                ...
                {
                    me.$cat.put('api/Actualizaciones/EditarActualizacion', 
                    {
            ...
            desactivarAnuncio(item)
            {
                ...
                me.$cat.put('api/Actualizaciones/DesactivarAviso', 
                    {
            ...
            editActualizacion(item)
            {
                ...
                me.fechaA =me.fechaActualizacion.substring(8, 10) +" de " +me.obtenermes(me.fechaActualizacion.substring(5, 7) - 1) +" del " +me.fechaActualizacion.substring(0, 4);
