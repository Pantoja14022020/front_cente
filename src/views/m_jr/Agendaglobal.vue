    ...
    <v-card> 
        <v-container fluid> 
                                              ...
                                              <v-toolbar
                                               ...
                                               <v-list two-line subheader>
                                                          ...
                                                          <v-list-tile  avatar   v-for="(item, i) in listaC" :key="i">
                                                            <v-list-tile-avatar>
                                                              <v-icon class="warning white--text"></v-icon>
                                                            </v-list-tile-avatar>
          ...
          <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Filtros.</v-toolbar-title>
            ...
            <v-card-actions>
              <v-btn color="primary" flat @click="dialogfilter=false">Cerrar</v-btn>
            </v-card-actions>
          </v-card>
        </v-dialog>
