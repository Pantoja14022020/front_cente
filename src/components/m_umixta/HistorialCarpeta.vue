  ...
  export default {
    ...
    created () {
            let me = this 
                ...
                me.u_iddsp = this.$store.state.usuario.iddsp;
                //*********************************************** */
    ...
    methods:{ 
        ...
        verhistorial(item){
            ...
            this.$cat.get('api/Historialcarpeta/Listar/' + item.rHechoId,configuracion).then(function(response){
        ...
        listarconfiltro(){
            ...
            if(me.nombre == "" || me.nombre == undefined){nombre = 'ZKR'}
            else nombre = me.nombre

            if(me.apellidop == "" || me.apellidop == undefined){apellidop = 'ZKR'}
            else apellidop = me.apellidop

            if(me.apellidom == "" || me.apellidom == undefined){apellidom = 'ZKR'}
            else apellidom = me.apellidom

            if(me.nuc == "" || me.nuc == undefined){nuc = 'ZKR'}
            else nuc = me.nuc
