    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
                    ...
                    <td class="justify-center layout px-0">
                        <v-tooltip bottom>
                            <template v-slot:activator="{ on }">
                                <v-icon class="mr-2" v-on="on" @click="actualizarclasi(props.item)">
                                    update
                                </v-icon>                                                                 
                            </template>
                        ...
                        <v-tooltip bottom>
                            <template v-slot:activator="{ on }">
                                <v-icon class="mr-2" v-on="on" color="warning" @click="infoItem(props.item)">
                                    info
                                </v-icon>
                            </template>
            ...
            <v-dialog v-model="modalAdd" fullscreen hide-overlay transition="dialog-bottom-transition">  
                <v-card>
                    ...
                    <v-stepper v-model="step" non-linear vertical>
                                ...
                                <v-container grid-list-lg>
                                    <v-layout wrap justify-space-between>
                                        <v-flex xs12 md5 lg5> 
                                            ...
                                            />
                                            <v-switch v-if="!switch2" v-model="RangoEdadTF" :label="'¿Desconoce la fecha de nacimiento? Agregar un rango de edad'"  color="success"  hide-details></v-switch>
                                            <v-autocomplete
                                                name="rangos"
                                                :items="rangosedad"
                                                v-model="rangoedad"
                                        ...
                                        <v-flex xs12 md6 lg6>
                                            ...
                                            />
                                            <br/>
                                            <v-toolbar v-if="!switch2" color="primary" dark> 
                                    ...
                                    <div class="text-xs-right">
                                        <v-btn v-if="!switch2" color="primary" @click.native="step = 2">Continuar</v-btn>
                                    </div>
                                </v-container>
                            </v-card>
                        </v-stepper-content>
                                    ...
                                    <v-layout wrap justify-space-between>
                                        ...
                                        <v-flex xs12 md6 lg6>
                                            ...
                                            <v-switch 
                                                v-model="presexuales" 
                                                v-if="switch2==false" 
                                                label="¿Desea manifestar sus preferencias sexuales?:" 
                                                color="success" 
                                                hide-details 
                                            />
                                            <v-switch 
                        ...
                        <v-stepper-step v-if="!switch2" :complete="step > 3" step="3" editable :rules="[]">
                            Dirección personal
                        </v-stepper-step>
                        ...
                        <v-stepper-step v-if="!switch2" :complete="step > 4" step="4" editable :rules="[]">
                            ...
                            <v-card color="grey lighten-5" elevation=0 class="mb-5" height="auto">
                                <v-container grid-list-xl>
                                    <v-layout wrap justify-space-between>
                                        <v-flex xs12 md5 lg5>
                                            <v-switch 
                                                v-model="duplicarDireccion" 
                                                @change="dupdiresc()" 
                                                label="¿La dirección de notificación es la misma que la dirección personal?:" 
                                                color="success" 
                                                hide-details 
                                            />
                                            <v-text-field 
                                        ...
                                        <v-flex xs12 md6 lg6>
                                            ...
                                            <v-btn block="" v-if="switch2==false" @click.native="btn_geoloc01" outline color="primary">
                                                <v-icon>location_on</v-icon>Croquis01
                                            </v-btn>
                                        </v-flex>
                                    </v-layout>
                                    <div class="text-xs-right">
            ...
            <v-dialog v-model="modalGeolocalizacion01" fullscreen hide-overlay transition="dialog-bottom-transition"> 
                <v-card>
                    <v-toolbar dark color="primary">
                        <v-toolbar-title>Geolocalización01.</v-toolbar-title>
                        <v-spacer />
                        <v-toolbar-items>
                            <v-btn color=success text @click.native="guardarGeolocalizacion01()">GUARDAR</v-btn>
                                                            ...
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    ...
                                                                    <v-list-tile-sub-title>
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.nombre }}</a></p>  
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile> 
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    <v-list-tile-title> 
                                                                        <p class="body-2 font-weight-bold"><a>Clasificación de persona:</a></p>
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title> 
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.clasificacionPersona }}</a></p>
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile> 
                                                            <v-list-tile>
                                                                ...
                                                                <v-list-tile-content>  
                                                                    <v-list-tile-title> 
                                                                        <p class="body-2 font-weight-bold"><a>Sexo:</a></p> 
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title> 
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.sexo }}</a></p>  
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile>                                                                                    
                                                        </v-list>  
                                                    ...
                                                    <v-card-text>
                                                        <v-list one-line> 
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    <v-list-tile-title> 
                                                                        <p class="body-2 font-weight-bold"><a>Apellido paterno:</a></p> 
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title> 
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.apellidoPaterno }}</a></p>  
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile>                                            
                                                        </v-list> 
                                                        <v-list-tile>  
                                                            ...
                                                            <v-list-tile-content>  
                                                                <v-list-tile-title> 
                                                                    <p class="body-2 font-weight-bold"><a>Alias:</a></p> 
                                                                </v-list-tile-title> 
                                                                <v-list-tile-sub-title> 
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.alias }}</a></p>  
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>                                            
                                                        <v-list-tile>  
                                                            ...
                                                            <v-list-tile-content>  
                                                                <v-list-tile-title> 
                                                                    <p class="body-2 font-weight-bold"><a>Entidad federativa de nacimiento:</a></p> 
                                                                </v-list-tile-title> 
                                                                <v-list-tile-sub-title> 
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.entidadFederativa }}</a></p>  
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>                                            
                                                    </v-card-text> 
                                                    ...
                                                    <v-card-text>
                                                        <v-list one-line> 
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    <v-list-tile-title> 
                                                                        <p class="body-2 font-weight-bold"><a>Apellido materno:</a></p> 
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title> 
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.apellidoMaterno }}</a></p>  
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile>                                            
                                                        </v-list> 
                                                        <v-list-tile>  
                                                            ...
                                                            <v-list-tile-content>  
                                                                <v-list-tile-title> 
                                                                    <p class="body-2 font-weight-bold"><a>Fecha de nacimiento:</a></p>
                                                                </v-list-tile-title> 
                                                                <v-list-tile-sub-title> 
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.fechaNacimiento == '01/01/0001'?"Anonimo":datospersona.fechaNacimiento }}</a></p>  
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>                                            
                                                        <v-list-tile>  
                                                            ...
                                                            <v-list-tile-content>  
                                                                <v-list-tile-title> 
                                                                    <p class="body-2 font-weight-bold"><a>CURP:</a></p> 
                                                                </v-list-tile-title> 
                                                                <v-list-tile-sub-title> 
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.curp }}</a></p> 
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>                                                                                     
                                                    </v-card-text> 
                                                    ...
                                                    <v-card-text>
                                                        <v-list three-line> 
                                                            <v-list-tile> 
                                                                ...
                                                                <v-list-tile-content>
                                                                    <v-list-tile-title> 
                                                                        <p class="body-4 font-weight-bold"><a>Documento de identificación:</a></p> 
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title>
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ tdocumento }}</a></p>  
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile>
                                                        </v-list>  
                                                    ...
                                                    <v-card-text>
                                                        <v-list one-line>
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    <v-list-tile-title> 
                                                                        <p class="body-2 font-weight-bold"><a>Medio de notificación:</a></p> 
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title> 
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.medionotificacion }}</a></p>  
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile> 
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    <v-list-tile-title>
                                                                        <p class="body-2 font-weight-bold"><a>Género:</a></p> 
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title> 
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.genero }}</a></p>  
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile> 
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    <v-list-tile-title> 
                                                                        <p class="body-2 font-weight-bold"><a>Ocupación:</a></p> 
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title> 
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.ocupacion }}</a></p>
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile>     
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    <v-list-tile-title> 
                                                                        <p class="body-2 font-weight-bold"><a>Religión:</a></p>
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title> 
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.religion }}</a></p>
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile> 
                                                            <v-list-tile v-if="datospersona.discapacidad">  
                                                                ...
                                                                <v-list-tile-content>
                                                                    <v-list-tile-title> 
                                                                        <p class="body-2 font-weight-bold"><a>Tipo de discapacidad:</a></p>
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title>
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.tipoDiscapacidad }}</a></p>
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile>                                                                              
                                                        </v-list>  
                                                    ...
                                                    <v-card-text>
                                                        <v-list one-line> 
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    <v-list-tile-title> 
                                                                        <p class="body-2 font-weight-bold"><a>Telefono 1:</a></p> 
                                                                    </v-list-tile-title> 
                                                        ...
                                                        <v-list-tile>
                                                            ...
                                                            <v-list-tile-content>  
                                                                ...
                                                                <v-list-tile-sub-title>
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.telefono2 }}</a></p>
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>                                            
                                                        <v-list-tile>  
                                                            ...
                                                            <v-list-tile-content>  
                                                                <v-list-tile-title> 
                                                                    <p class="body-2 font-weight-bold"><a>Nivel de estudios:</a></p>
                                                                </v-list-tile-title> 
                                                                <v-list-tile-sub-title>
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.nivelEstudio }}</a></p>  
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>   
                                                        <v-list-tile>  
                                                            ...
                                                            <v-list-tile-content>  
                                                                <v-list-tile-title>
                                                                    <p class="body-2 font-weight-bold"><a>Estado familiar:</a></p> 
                                                                </v-list-tile-title> 
                                                                <v-list-tile-sub-title> 
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.estadoCivil }}</a></p>  
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>                                         
                                                    </v-card-text> 
                                                    ...
                                                    <v-card-text>
                                                        <v-list one-line> 
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>
                                                                    <v-list-tile-title> 
                                                                        <p class="body-2 font-weight-bold"><a>Correo electronico:</a></p> 
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title> 
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.apellidoMaterno }}</a></p>  
                                                                    </v-list-tile-sub-title>  
                                                        ...
                                                        <v-list-tile>  
                                                            ...
                                                            <v-list-tile-content>
                                                                <v-list-tile-title> 
                                                                    <p class="body-2 font-weight-bold"><a>Lengua:</a></p> 
                                                                </v-list-tile-title> 
                                                                <v-list-tile-sub-title>
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.lengua }}</a></p>
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>                                            
                                                        <v-list-tile>  
                                                            ...
                                                            <v-list-tile-content>  
                                                                <v-list-tile-title>
                                                                    <p class="body-2 font-weight-bold"><a>Nacionalidad:</a></p>
                                                                </v-list-tile-title> 
                                                                <v-list-tile-sub-title>
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.nacionalidad }}</a></p>
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>  
                                                        <v-list-tile>  
                                                            ...
                                                            <v-list-tile-content>  
                                                                <v-list-tile-title> 
                                                                    <p class="body-2 font-weight-bold"><a>¿Tiene alguna discapacidad ?:</a></p>
                                                                </v-list-tile-title> 
                                                                <v-list-tile-sub-title>
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ datospersona.discapacidad ? "Si" : "No" }}</a></p>
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>                                                                                   
                                                    </v-card-text> 
                                                    ...
                                                    <v-card-text>
                                                        <v-list one-line>
                                                            ...
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    <v-list-tile-title> 
                                                                        <p class="body-2 font-weight-bold"><a>No.Exterior:</a></p> 
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title>
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ infodp.noext }}</a></p>  
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile> 
                                                            <v-list-tile>
                                                                ...
                                                                <v-list-tile-content>  
                                                                    <v-list-tile-title> 
                                                                        <p class="body-2 font-weight-bold"><a>No.Interior:</a></p> 
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title>
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ infodp.noint }}</a></p>
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile>     
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    <v-list-tile-title> 
                                                                        <p class="body-2 font-weight-bold"><a>Código postal:</a></p>
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title>
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ infodp.cp }}</a></p>
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile>                                                                             
                                                        </v-list>  
                                                    ...
                                                    <v-card-text>
                                                        <v-list one-line> 
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    <v-list-tile-title> 
                                                                        <p class="body-2 font-weight-bold"><a>Pais:</a></p> 
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title>
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ infodp.pais }}</a></p>
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile>                                            
                                                        </v-list> 
                                                        <v-list-tile>
                                                            ...
                                                            <v-list-tile-content>
                                                                <v-list-tile-title>
                                                                    <p class="body-2 font-weight-bold"><a>Estado:</a></p>
                                                                </v-list-tile-title> 
                                                                <v-list-tile-sub-title>
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ infodp.estado }}</a></p>
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>                                            
                                                        <v-list-tile>  
                                                            ...
                                                            <v-list-tile-content>
                                                                <v-list-tile-title>
                                                                    <p class="body-2 font-weight-bold"><a>Municipio:</a></p> 
                                                                </v-list-tile-title> 
                                                                <v-list-tile-sub-title>
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ infodp.municipio }}</a></p>
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>   
                                                        <v-list-tile>  
                                                            ...
                                                            <v-list-tile-content>
                                                                <v-list-tile-title>
                                                                    <p class="body-2 font-weight-bold"><a>Localidad:</a></p> 
                                                                </v-list-tile-title> 
                                                                <v-list-tile-sub-title>
                                                    ...
                                                    <v-card-text>
                                                        <v-list one-line> 
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    <v-list-tile-title>
                                                                        <p class="body-2 font-weight-bold"><a>Entre calle 1:</a></p> 
                                                                    </v-list-tile-title> 
                                                                    <v-list-tile-sub-title>
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ infodp.entrecalle1 }}</a></p>  
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile>                                            
                                                        </v-list> 
                                                        <v-list-tile>
                                                            ...
                                                            <v-list-tile-content>
                                                                <v-list-tile-title> 
                                                                    <p class="body-2 font-weight-bold"><a>Entre calle 2:</a></p> 
                                                                </v-list-tile-title> 
                                                                <v-list-tile-sub-title>
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ infodp.entrecalle2 }}</a></p>
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>                                             
                                                        <v-list-tile>  
                                                            ...
                                                            <v-list-tile-content>  
                                                                <v-list-tile-title>
                                                                    <p class="body-2 font-weight-bold"><a>Referencia:</a></p> 
                                                                </v-list-tile-title> 
                                                                <v-list-tile-sub-title>
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ infodp.referencia }}</a></p>
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>                                                                                   
                                                    </v-card-text> 
                                                    ...
                                                    <v-card-text>
                                                        <v-list one-line> 
                                                            ...
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    <v-list-tile-title> 
                                                                        <p class="body-2 font-weight-bold"><a>No.Exterior:</a></p> </v-list-tile-title> 
                                                    ...
                                                    <v-card-text>
                                                        <v-list one-line>
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    ...
                                                                    <v-list-tile-sub-title>
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ infode.pais }}</a></p>
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile>                                            
                                                        </v-list> 
                                                        <v-list-tile>
                                                            ...
                                                            <v-list-tile-content>  
                                                                ...
                                                                <v-list-tile-sub-title>
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ infode.estado }}</a></p>  
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>                                            
                                                        <v-list-tile>  
                                                            ...
                                                            <v-list-tile-content>  
                                                                ...
                                                                <v-list-tile-sub-title>
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ infode.municipio }}</a></p>  
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>   
                                                        <v-list-tile>  
                                                    ...
                                                    <v-card-text>
                                                        <v-list one-line> 
                                                            <v-list-tile>  
                                                                ...
                                                                <v-list-tile-content>  
                                                                    ...
                                                                    <v-list-tile-sub-title>
                                                                        <p color="accent" class="caption font-weight-regular"><a>{{ infode.entrecalle1 }}</a></p>
                                                                    </v-list-tile-sub-title>  
                                                                </v-list-tile-content> 
                                                            </v-list-tile>                                            
                                                        </v-list> 
                                                        <v-list-tile>
                                                            ...
                                                            <v-list-tile-content>  
                                                                ...
                                                                <v-list-tile-sub-title>
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ infode.entrecalle2 }}</a></p>
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>                                             
                                                        <v-list-tile>  
                                                            ...
                                                            <v-list-tile-content>  
                                                                ...
                                                                <v-list-tile-sub-title>
                                                                    <p color="accent" class="caption font-weight-regular"><a>{{ infode.referencia }}</a></p>
                                                                </v-list-tile-sub-title>  
                                                            </v-list-tile-content> 
                                                        </v-list-tile>                                                                                   
                                                    </v-card-text> 
...
<script> 
    ...
    export default {
        ...
        created () {
            ...
            if (me.rac == null) {
                me.$alert('Notificación', 'Aun no ha abierto ningun RAC por favor ingrese al menu RACS y luego en Listar RACS y ahi abra el rac que usted elija!. En este momento sera redireccionado al menu correspondiente.', 
                function() {
            ...
            guardar () {
                this.$validator.validate().then(result => {
                    if (result) { 
                        ...
                        let header = { "Authorization" : "Bearer " + this.$store.state.token };
                        let configuracion = { headers : header };
                        console.log(me.discapacidad)


                        //GUARDAR VARIAS DISCAPACIDADES
                            ...
                            if (me.statusActualizar == true) {
                                this.$cat.post('api/RAPs/Insertar', {
                                    ...
                                    if (this.imageFile) {
                                        ...
                                        this.$cat.post('api/RAtencions/Post/' + nombreCarpeta + '/' + me.GUID, formData, {
                                            headers: {
