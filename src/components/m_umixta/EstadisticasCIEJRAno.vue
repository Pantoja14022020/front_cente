        ...
        listarporfecha(){
          ...
          me.$validator.validate().then(result => {
            if (result) {
                ...
                let header={"Authorization" : "Bearer " + this.$store.state.token};
                let configuracion= {headers : header};
                    this.$cat.get('api/RHechoes/ContarCarpetasiniciadas/'+me.u_iddsp+'/'+ me.fechaInicio +" 00:00:00"+'/'+me.fechaFin+" 23:59:59",configuracion).then(function(response){
                    me.carpetasmodulos2=response.data;
                        this.$cat.get('api/RHechoes/ContarCarpetasiniciadasFechaAño/'+me.u_iddsp+'/'+ me.fechaInicio +" 00:00:00"+'/'+me.fechaFin+" 23:59:59",configuracion).then(function(response){
                        me.carpetasfecha2=response.data;
                            me.$justiciarestaurativa.get('api/Envios/ContarCarpetasiniciadas/'+ me.fechaInicio +" 00:00:00"+'/'+me.fechaFin+" 23:59:59",configuracion).then(function(response){
                                me.carpetasmodulos3=response.data;
                                    me.$justiciarestaurativa.get('api/Envios/ContarCarpetasiniciadasFechaAño/'+ me.fechaInicio +" 00:00:00"+'/'+me.fechaFin+" 23:59:59",configuracion).then(function(response){
                                    me.carpetasfecha3=response.data;
                                        ...
                                        me.carpetasfecha2.forEach(function (registro){
                                            me.carpetasfecha.push({fecha:registro.fechas,ciniciadas:registro.ciniciadas,envios:0})
                                        });
                                        var entre = false;

                                        me.carpetasfecha3.forEach(function (registro){
                                            for(var i=0;i<me.carpetasfecha.length;i++){
                                                if(registro.fechas == me.carpetasfecha[i].fecha){
                                            ...
                                            if(!entre)
                                                me.carpetasfecha.push({fecha:registro.fechas,ciniciadas:0,envios:registro.envios})
                                                entre= false
                                        });
                                    ...
                                    me.textotitulo2 = "Estadísticas de "+me.fechai+ " a "+me.fechaf+" por mes";
                    ...
                    me.$notify('Los años de las fechas no coinciden','error')
                }
                }
            })
        },
