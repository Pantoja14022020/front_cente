  ...
  export default {
    ...
    data: () => ({
        ...
        headers: [
            ...
            { text: 'Observaciones', value: 'dirigidoa' },           
    ...
    methods:{ 
           ...
           this.$validator.validate().then(result => {
                    if (result) { 
                            ...
                            function(){ 
                                ...
                                if(me.evento.value != 20)
                                    eventof = me.evento.text
                                else   
                                    eventof = me.eventosec
        ...
        listar(){
          ...
          let header={"Authorization" : "Bearer " + this.$store.state.token};
          let configuracion= {headers : header};
                me.$IL.get('api/Agenda/ListarTipoRHecho/'+me.rHechoId +"/"+10,configuracion).then(function(response){
