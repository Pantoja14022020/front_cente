            ...
            if (result) {
                ...
                let configuracion= {headers : header};
                    ...
                    me.carpetasmodulos2=response.data;
                        this.$cat.get('api/RHechoes/ContarCarpetasiniciadasFechaMes/'+me.u_iddsp+'/'+ me.fechaInicio +" 00:00:00"+'/'+me.fechaFin+" 23:59:59",configuracion).then(function(response){
