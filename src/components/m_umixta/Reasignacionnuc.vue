    ...
    export default {
        ...
        methods:{
            listar(){
                ...
                this.$cat.get('api/RHechoes/ListarPorAgenciaNUCS/' + me.u_idagencia,configuracion).then(function(response){
        ...
        reasignar(){
            ...
            var descripcionRegTabI = "Registro de reasignación de carpeta al modulo " + me.modulo.text;
