              ...
              <v-layout row wrap>
                ...
                <v-flex xs12 sm12 md6 lg6>
                  ...
                  <v-autocomplete
                    ...
                    v-validate="'required'"
                    return-object
                    :error-messages="errors.collect('pi')"
                  >
                  </v-autocomplete>
                </v-flex>
...
export default {
  ...
  created() {
    ...
    me.rAtencionId2 = me.$store.state.ratencionid;
    if (me.rac == null) {
      me.$alert(
        "Notificación",
  ...
  methods: {
    ...
    imprimirdiligencia(item) {
      ...
      me.generarQR(me.docActoInv,me.rac,item.uUsuario,item.fechaSys,item.idRActosInvestigacion);
      ...
      this.$validator.validate().then((result) => {
        if (result) {
          ...
          if (me.rautorizacionj)
            //textosi
            me.textolibre =
              "<p>Por medio de la presente, solicito tenga a bien solicitar  servicios, a efecto de los siguientes actos de investigación:";
          //textono
          else
            me.textolibre =
              "<p>Por medio de la presente, solicito tenga a bien solicitar  servicios, a efecto de los siguientes actos de investigación:";
          ...
          me.textofinal =
            "<b>Agente de investigación en turno</b><br><p><p>" +
            "<p>PRESENTE.</p> <p><br></p>" +
            "<p><br></p>" +
            me.textolibre +
            "<p><br></p><p><br></p>" +
