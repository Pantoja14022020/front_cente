        ...
        [
            ...
            table: {
              ...
              body: [
                ...
                [
                  ...
                  { style: 'Texto', text: (!padre.calleOcupacion? 'Ninguno' : (padre.calleOcupacion + (padre.noIntOcupacion == '' ? ' ' : ', numero ' + padre.noIntOcupacion) + ', ' + (padre.localidadOcupacion == undefined ? ' ' : padre.localidadOcupacion) + ', ' + (padre.municipioOcupacion == undefined ? ' ' : padre.municipioOcupacion))), alignment: 'center' },
                ...
                [
                  ...
                  { style: 'Texto', colSpan: 3, text: padre.calle.toUpperCase() == '' ? 'No registrado' : padre.calle.toUpperCase() + ', ' + padre.noExt.toUpperCase() + ', ' + padre.noInt.toUpperCase() + ', ' + padre.localidad.toUpperCase() + ', ' + padre.municipio.toUpperCase(), alignment: 'center' },
                ],
              ]
            },
            layout: {
          ...
          },
          {
            ...
            table: {
              ...
              body: [
                ...
                [
                  { style: 'Titulo', colSpan: 1, text: "Calle", fillColor: '#eeeeee', fontSize: 9, bold: true, alignment: 'center' },
                ...
                [
                  ...
                  { style: 'Titulo', colSpan: 1, text: "Referencias", fillColor: '#eeeeee', fontSize: 9, bold: true, alignment: 'center' },
                ],
                [
                  ...
                  { style: 'Texto', text: padre.referenciaH == '' ? 'Ninguna' : padre.referenciaH, alignment: 'center' },
                ],
                [
          ...
          },
          {
            ...
            table: {
              ...
              body: [
                [
                  { style: 'Titulo', colSpan: 1, text: "Calle", fillColor: '#eeeeee', fontSize: 10, bold: true, alignment: 'center' },
                ...
                [
                  ...
                  { style: 'Titulo', colSpan: 1, text: "Referencias", fillColor: '#eeeeee', fontSize: 10, bold: true, alignment: 'center' },
                ],
                [
                  ...
                  { style: 'Texto', colSpan: 1, text: padre.referenciaD.toUpperCase() == '' ? 'No registrada' : padre.referenciaD.toUpperCase(), alignment: 'center' },
                ],
              ]
            },
            layout: {
