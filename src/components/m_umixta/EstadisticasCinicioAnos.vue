        ...
        listarporfecha(){
          ...
          me.$validator.validate().then(result => {     
            if (result) {   
                let header={"Authorization" : "Bearer " + this.$store.state.token};
                let configuracion= {headers : header};
                        this.$cat.get('api/RHechoes/InformacionCompleta/'+me.u_iddsp+'/'+ me.fechai+"-01-01 00:00:00.0000000"+'/'+me.fechaf+"-12-31 23:23:59.0000000",configuracion).then(function(response){
                            me.carpetas=response.data;
                                ...
                                me.carpetasmodulos=response.data;
                                    ...
                                    me.carpetasfecha.push({fecha: 'Total',ciniciadas: cont2 });
                                    ...
                                    for(var i=0;i<me.carpetasfecha.length-1;i++){
                                        me.crear2();
                                        me.graficarindividual(me.carpetasfecha[i].fecha,me.carpetasfecha[i].ciniciadas);
                                        me.conteograficas++;
                                    }
