    ...
    <n403 v-if="e403" />
      <v-flex v-if="showpage">
        <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Exhortos, Requisitorios y Suplicatorios</v-toolbar-title>
        ...
        <v-dialog v-model="dialogo" fullscreen hide-overlay transition="dialog-bottom-transition">
            ...
            <v-toolbar dark color="primary">
                ...
                <v-toolbar-title>Registrar exhorto</v-toolbar-title>
                <v-spacer></v-spacer>
                <v-toolbar-items>
                ...
                <v-layout row wrap>
                    <v-flex class="espaciado" xs12 sm12 md6 lg6 >
                        ...
                        <v-text-field 
                            ...
                            v-model='recepcion' 
                            v-validate="'required'" 
                            :error-messages="errors.collect('recepción')"
                        ></v-text-field>
                    ...
                    <v-flex class="espaciado" xs12 sm12 md6 lg6 >
                        ...
                        <v-text-field 
                            ...
                            v-model='agraviado' 
                            v-validate="'required'" 
                            :error-messages="errors.collect('agraviado')"
                        ></v-text-field>
                    ...
                    <v-flex class="espaciado" xs12 sm12 md12 lg12 >
                        <v-card elevation="0" >
                            <v-card-title class="accent"><h3>Acto a realizar</h3></v-card-title>
                                <v-card-text>
                                    <vue-editor                                         
                                        v-model="actorealizar" 
           ...
           this.$validator.validate().then(result => {
                    if (result) { 
                            ...
                            axios.post('api/Exhorto/Crear',{  
                                ...
                                'Delito':me.delito,
                                'Agraviado' :me.agraviado,
                                'CausaPenal' :me.causapenal.text,
                                'ActosRealizar': me.actorealizar,
