    ...
    <n403 v-if="e403" />
      <v-flex v-if="showpage">
        <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Ordenes de Aprehensión</v-toolbar-title>
        ...
        <v-dialog v-model="dialogo" fullscreen hide-overlay transition="dialog-bottom-transition">
            ...
            <v-toolbar dark color="primary">
                ...
                <v-toolbar-title>Registrar orden de aprehension</v-toolbar-title>
                <v-spacer></v-spacer>
                <v-toolbar-items>
            ...
            <v-container grid-list-md text-xs-center>
                <v-layout row wrap>
                    <v-flex class="espaciado" xs12 sm12 md6 lg6 >
                        ...
                        <v-autocomplete name="autoridad que ordena" 
                            :items="juzgados"
                            v-model="juzgado" 
                            return-object  
                            v-validate="'required'" 
                            label="*Autoridad que ordena:"
                            :error-messages="errors.collect('autoridad que ordena')">
                        </v-autocomplete>

                        <v-text-field 
                            name="oficialia de partes o directa"
                            label="*Oficialia de partes o directa:" 
                            v-model='oficialiapartesdirecta' 
                            v-validate="'required'" 
                            :error-messages="errors.collect('oficialia de partes o directa')"
                        ></v-text-field>
                        ...
                        <v-text-field 
                            ...
                            v-model='oficio' 
                            v-validate="'required'" 
                            :error-messages="errors.collect('oficio')"
                        ></v-text-field>
                        ...
                        >
                            ...
                            ></v-text-field>
                                ...
                                <v-spacer></v-spacer>
                                <v-btn text color="primary" @click="menu22 = false">Cancel</v-btn>
                        ...
                        >
                            ...
                            ></v-text-field>
                                ...
                                <v-spacer></v-spacer>
                                <v-btn text color="primary" @click="menu44 = false">Cancel</v-btn>
                                <v-btn text color="primary" @click="fechainif()">OK</v-btn>
                                </v-date-picker>
                        </v-menu>
                    ...
                    <v-flex class="espaciado" xs12 sm12 md6 lg6 >
                        ...
                        <v-text-field 
                            ...
                            v-model='arc' 
                            v-validate="'required'" 
                            :error-messages="errors.collect('A//R/C')"
                        ></v-text-field>

                        <v-text-field 
                            name="indiciado y/o imputado"
                            label="*Indiciado y/o Imputado:" 
                            v-model='indiciadoimputado' 
                            v-validate="'required'" 
                            :error-messages="errors.collect('indiciado y/o imputado')"
                        ></v-text-field>
                        ...
                        <v-text-field 
                            ...
                            v-model='agraviados' 
                            v-validate="'required'" 
                            :error-messages="errors.collect('agraviados')"
                        ></v-text-field>
                        ...
                        >
                            ...
                            ></v-text-field>
                                ...
                                <v-spacer></v-spacer>
                                <v-btn text color="primary" @click="menu33 = false">Cancel</v-btn>
                                <v-btn text color="primary" @click="fechainif()">OK</v-btn>
                                </v-date-picker>
                        </v-menu>
...
<script> 
  ...
  export default {
    ...
    data: () => ({
        ...
        OrdenAprension:[],
        juzgados:[
            {text:'Tribunal de enjuiciamiento', value: 1},
            {text:'Juez penal de control', value: 2},
            {text:'Juez penal 1era instancia', value: 3},
            {text:'Juez mixto', value: 4},
            {text:'Juez de ejecución', value: 5},
        ],
        juzgado:'',
        oficialiapartesdirecta:'',
        causapenales:[
        ...
        headers: [
            ...
            { text: 'Autoridad que ordena', value: 'juzgado' }, 
    ...
    methods:{ 
           ...
           this.$validator.validate().then(result => {
                    if (result) { 
                            ...
                            me.$PI.post('api/OrdenAprension/Crear',{  
                                ...
                                'Oficio' :me.oficio,
                                'ARC' :me.arc,
                                'Imputado':me.indiciadoimputado,
                                'Delito' :me.delitos,
                                'Agraviado' :me.agraviados,
                                'Recibida' :"",
        ...
        limpiar(){    
            ...
            me.fechare = ""
            me.juzgado ='';
            me.oficialiapartesdirecta ='';
            me.causapenal ='';
            me.oficio ='';
            me.arc ='';
            me.indiciadoimputado ='';
            me.delitos ='';
            me.agraviados ='';
            me.observaciones ='';
        },
        ...
        fechainif(){
            if(this.menu1){
                this.generarfecha2();
            this.$refs.menu1.save(this.diaaa);
            }          

            if(this.menu22){
                this.generarfecha2();
            this.$refs.menu22.save(this.fechacomparecencia);
            }   
            if(this.menu33){
                this.generarfecha2();
            this.$refs.menu33.save(this.fechacumplimiento);
            }   
            if(this.menu44){
                this.generarfecha2();
            this.$refs.menu44.save(this.fecharecepcion);
            }    
        },
        generarfecha2(){           
            if(this.menu1) 
            this.dia =this.diaaa.substring(8,10) +" de "+ this.obtenermes(this.diaaa.substring(5,7)-1)+
            " del "+ this.diaaa.substring(0,4);   

            if(this.menu22) 
            this.fechaco =this.fechacomparecencia.substring(8,10) +" de "+ this.obtenermes(this.fechacomparecencia.substring(5,7)-1)+
