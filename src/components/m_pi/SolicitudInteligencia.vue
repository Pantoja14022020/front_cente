    ...
    <n403 v-if="e403" />
      <v-flex v-if="showpage">
        <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Solicitudes a inteligencia</v-toolbar-title>
        ...
        <v-data-table
                ...
                <template slot="items" class="white" slot-scope="props">
                    ...
                    <td class="justify-center layout px-0">
                        ...
                        <div class=" layout px-0" v-if="props.item.statusMensaje != 'Finalizado'" >
                            <v-tooltip bottom   >
                                <template v-slot:activator="{ on }">
                                    <v-icon 
                                        class="mr-2" v-on="on" 
                                        @click="activardialogoresponder(props.item)"
                                        >
                                    done
                                    </v-icon> 
                                </template>
                                <span>Cambiar Status/ Responder</span>
                            </v-tooltip> 
                        </div>             
                    </td>   
                </template>
        ...
        <v-dialog  v-model="dialogoresponder"  max-width="1000px" >
                ...
                <v-toolbar card dark color="grey lighten-4 primary--text">
                    ...
                    <v-card-text>
                        <v-form ref="form"  >
                                ...
                                <v-layout row wrap>
                                    <v-flex xs12 sm12 md12 lg12>
                                        <v-autocomplete name="estatus"   
                                         ...
                                         <v-card elevation="0"  >
                                            <v-card-title class="accent"><h3>*Respuesta / Estado</h3></v-card-title>
                                                <v-card-text>
                                                     <vue-editor  
                                                        name="respuesta"                                        
                                                        v-model="respuesta" 
                            ...
                            <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-btn @click="dialogoresponder=false" >Cerrar</v-btn>   
                                <v-btn color="success" @click="responder()" >Guardar</v-btn>                          
                            </v-card-actions> 
                        </v-form>
...
<script> 
  ...
  export default {
    ...
    data: () => ({
        ...
        mensajeso:'',
        dialogoresponder:false,
        status: [

            { text: 'Pospuesto', value: '1'  }, 
    ...
    methods:{ 
        ...
        activardialogoresponder(item){
            let me = this;
            me.dialogoresponder = true;
            me.solicitudInteligenciaId = item.solicitudInteligenciaId;
        },
        responder(item){
            let me=this;                           
