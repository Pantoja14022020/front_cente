    ...
    <n403 v-if="e403" />
      <v-flex v-if="showpage">
        <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Bandeja de Entrada</v-toolbar-title>
...
<script> 
  ...
  export default {
    ...
    computed: {
      formTitle () {
                return this.editedIndex === -1 ? 'Asignar unidad polcial' : 'Razón Rechazado'
            },
      formIcon () {
    ...
    methods:{ 
        ...
        listar(){
          ...
          let configuracion= {headers : header};
                me.$CAT.get('api/RActosInvestigacion/Listar/'+ me.u_iddsp + '/' + me.u_iddistrito, configuracion).then(function(response){
                    console.log(response.data);
                    me.actosinvestigacion=response.data;
                }).catch(err => { 
        ...
        imprimirdocs(item){
            let me = this;
            me.textofinal = item.textofinal;
            me.fecha=item.fechaSolicitud;
            me.numeroficio = item.numeroOficio;
            me.nuc = item.nuc; 
            me.mostrarpdf(item.uUsuario,item.uPuesto,item.uAgencia);                   
        ...
        listarModulos(item){ 
            ...
            me.actosinvestigacionId = item.idRActosInvestigacion;
        ...
        generarfecha(){
            let me=this; 
            me.fechaactual =  moment().format('DD') + " de " + moment().format('MMMM')  + " del " + moment().format("YYYY")    
        },
        rechazarsoli(item){
            let me = this;
            me.limpiar();
        ...
        asignarperito(){
            ...
            if (result) { 
                if(this.editedIndex == -1){
                  ...
                  me.$PI.get('api/PeritoAsignadoPI/Listar',configuracion).then(function(response){
                        ...
                        me.$PI.post('api/PeritoAsignadoPI/Crear',{                         
                        'moduloServicioId' : me.modulo.value,
                        'rActoInvestigacionId': me.actosinvestigacionId,
                        'respuesta': "na",
                        ...
                        me.$CAT.put('api/RActosInvestigacion/Actualizarstatus',{
                            'idRActosInvestigacion': me.actosinvestigacionId,
                            'status': "Asignado"                   
                        },configuracion).then(function(response){                            
                    ...
                    me.$CAT.put('api/RActosInvestigacion/ActualizarstatusRespuesta',{
                        'idRActosInvestigacion': me.actosinvestigacionId,
                        'status': "Rechazado",
        ...
        downloadPdf(nombre,puesto,agencia) {
            ...
            var dd = {
                ...
                content: [
                    ...
                    {
                        text:'Número de oficio: ' +this.numeroficio ,                        
                        style: 'Nooficio',
                        alignment: 'right', 
                    },
                    {
