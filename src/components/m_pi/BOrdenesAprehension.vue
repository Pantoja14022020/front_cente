    ...
    <n403 v-if="e403" />
      <v-flex v-if="showpage">
        <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Bandeja de entrada Ordenes de aprehensión </v-toolbar-title>
        ...
        <v-data-table
                ...
                <template slot="items" class="white" slot-scope="props">
                    ...
                    <td>{{ props.item.oficialiaDPartes}}</td>   
                    <td>{{ props.item.causaPenal }}</td> 
                    <td>{{ props.item.arc }}</td>                     
                    <td>{{ props.item.imputado }}</td>  
                    <td>{{ props.item.delito }}</td> 
                    <td>{{ props.item.agraviado }}</td> 
                    ...
                    <td class="justify-center layout px-0"> 
                        ...
                        <v-tooltip bottom   >
                            ...
                            <span>Generar bitacora del día</span>
                        </v-tooltip>      
                        ...
                        <v-tooltip bottom   >
                            <template v-slot:activator="{ on }">
                                <v-icon 
                                    class="mr-2" v-on="on" 
                                    @click="consultararchivo2(props.item)"
                                    >
                                    pageview
                                </v-icon> 
                            </template>
       ...
       <v-dialog  v-model="dialog"  max-width="1000px" >
            ...
            <v-card>
                ...
                <v-card-text>
                <v-form ref="form" data-vv-scope="dialogostatus" >
                        <v-container grid-list-md>
                            ...
                            <v-flex xs12 sm12 md12 lg12>      
                                ...
                                <v-autocomplete name="status" 
                                    ...
                                    return-object 
                                    v-validate="'required'" 
                                    data-vv-scope="dialogostatus"
                                    label="*Nuevo Status:"                                                                                 
                                    :error-messages="errors.collect('dialogostatus.status')">
                                </v-autocomplete>
        ...
        <v-dialog v-model="dialogoinforme" fullscreen hide-overlay transition="dialog-bottom-transition">
            ...
            <v-toolbar dark color="primary">
                ...
                <v-spacer></v-spacer>
                <v-toolbar-items>
                <v-btn @click ="guardarBitacora()" color="success" >Guardar Bitácora </v-btn>
                   ...
                   <v-card-text>
                       ...
                       <v-container grid-list-md text-xs-center>
                        ...
                        <v-flex class="espaciado" xs12 sm12 md12 lg12 >
                            <v-card elevation="0"  >
                            <v-card-title class="accent"><h3>*Texto de la Bitácora </h3></v-card-title>
                            <v-card-text>
...
<v-dialog  v-model="dialogpictures"  max-width="1000px" >
            ...
            <v-card>
                <v-toolbar card dark color="grey lighten-4 primary--text">
                    ...
                    <v-toolbar-title class="subheading">Lista de bitácoras conforme días.</v-toolbar-title>
                    <v-spacer></v-spacer>
        ...
        <v-dialog  v-model="dialogimagen"  max-width="1000px" >
            ...
            <v-card>
                <v-toolbar card dark color="grey lighten-4 primary--text">
                    ...
                    <v-toolbar-title class="subheading">Informacion del archivo</v-toolbar-title>
                    <v-spacer></v-spacer>                  
                </v-toolbar>
                <v-card-text>
                            ...
                            <v-layout row wrap>
                                <v-flex xs12 sm12 md12 lg12>
                                    ...
                                    <v-card    auto-grow elevation="0">                                
                                        <v-card-text >
                                            <v-list three-line   > 
                                                <p class="text-lg-center font-weight-bold"><a>Información de bitacora</a></p> 
                                                <v-list-tile>  
                                                    <v-list-tile-action>
                                                    ...
                                                    <v-list-tile-content   >  
                                                        ...
                                                        <v-list-tile-sub-title   > <p   color="accent" class="caption font-weight-regular" v-html=descrip><a>{{ descrip }}</a></p>  </v-list-tile-sub-title>  
                                                    </v-list-tile-content> 
                                                </v-list-tile> 
                                            </v-list>  
                                        </v-card-text> 
        ...
        <v-dialog  v-model="dialogarchivo2"  max-width="1000px" >
                ...
                <v-card-text>
                    <v-form ref="form" data-vv-scope="dialogodocs" >
                        ...
                        <v-card-actions>
                            ...
                            <v-btn  @click.native="dialogarchivo2 == false" >Cancelar</v-btn>
                            <v-btn   @click="guardararchivo2()" class="success" >Guardar</v-btn>
        ...
        <v-dialog  v-model="dialogpictures2"  max-width="1000px" >
            ...
            <v-card>
                ...
                <v-card-text>
                    <v-form ref="form" >
                        ...
                        <v-card-actions>
                            <v-spacer></v-spacer>
                            <v-btn  @click.native="dialogpictures2=false" >Cerrar</v-btn>                                   
                        </v-card-actions> 
                    </v-form>
        ...
        <v-dialog  v-model="dialogimagen2"  max-width="1000px" >
            ...
            <v-card>
                ...
                <v-card-text>
                    ...
                    <v-form ref="form" >
                        ...
                        <v-card-actions>
                            <v-spacer></v-spacer>
                            <v-btn  @click.native="dialogimagen2=false" >Cerrar</v-btn>                                   
                        </v-card-actions> 
                    </v-form>
...
<script> 
  ...
  export default {
    ...
    data: () => ({
        ...
        descrip:'',
        statuses:[
            { text: 'Suspendida por amparo', value: '1' },
            { text: 'Comparecencia u otro', value: '2' },
            { text: 'Cancelada total', value: '3' },
            { text: 'Cancelada parcial', value: '4' },
            { text: 'Cancelada por prescripción', value: '5' },
            { text: 'Cancelada por muerte', value: '6' },
            { text: 'Cancelada por otra causa', value: '7' },
            { text: 'Cumplida parcial', value: '8' },
            { text: 'Cumplida Total', value: '9' },
        ],
        dialogarchivo2:false,
        dialogpictures2:false,
        dialogimagen2:false,
        tiposdocumentos:[
        ...
        headers: [
            ...
            { text: 'Oficialia de partes ', value: 'oficialiaDPartes' },
            { text: 'Causa penal', value: 'causaPenal' },
            { text: 'A//R/C', value: 'arc' },
            { text: 'Indiciado i/o Imputado',value: 'imputado' },      
            { text: 'Delito(s)',value: 'delito' }, 
            { text: 'Agraviado(s)',value: 'agraviado' }, 
    ...
    computed: {
      formTitle () {
                return this.editedIndex === -1 ? 'Subir archivo' : 'Generar bitácora del día'
            },
              formIcon () {
    ...
    methods:{ 
        ...
        activardialogosubir(item){
            this.limpiar();
            this.dialogarchivo2=true;
            this.IdOrdenAprension = item.idOrdenAprension;
        },
        verimagen(item){
            let me = this;
        ...
        verimagen2(item){
            ...
            me.descrip = item.descripcionDocumento;
            me.tipo = item.tipoDocumento;
            me.dialogimagen2= true;
        },
        activardialogstatus(item){
            let me = this;
            me.idcomparencia = item.idOrdenAprension;
            me.dialog = true;
            me.limpiar();
        },
        activarinfodialog(item){
            ...
            me.idPeritoAsignadoPI = item.idOrdenAprension;
            me.limpiar();
        ...
        consultararchivo(item){
         ...
         guardarBitacora(){
           this.$validator.validateAll('dialogodinforme').then(result => {
                    if (result) {   
                            let me=this;
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
