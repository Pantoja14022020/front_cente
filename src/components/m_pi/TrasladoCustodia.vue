    ...
    <n403 v-if="e403" />
      <v-flex v-if="showpage">
        <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Traslados y custodias</v-toolbar-title>
        ...
        <v-data-table
                ...
                <template slot="items" class="white" slot-scope="props">
                    ...
                    <td>{{ props.item.personaaTras }}</td>
                    <td>{{ props.item.lugar}}</td>                   
        ...
        <v-dialog v-model="dialogo" fullscreen hide-overlay transition="dialog-bottom-transition">
            ...
            <v-toolbar dark color="primary">
                ...
                <v-toolbar-title>Registrar traslado o custodia</v-toolbar-title>
                <v-spacer></v-spacer>
                <v-toolbar-items>
            ...
            <v-container grid-list-md text-xs-center>
                <v-layout row wrap>
                    <v-flex class="espaciado" xs12 sm12 md6 lg6 >
                        ...
                        >
                            ...
                            ></v-text-field>
                                ...
                                <v-date-picker locale="es" v-model="diaaa" no-title scrollable>
                                <v-spacer></v-spacer>
                    ...
                    <v-flex class="espaciado" xs12 sm12 md6 lg6 >
                        ...
                        <v-text-field 
                            name="persona a trasladar/custodiar"
                            label="*Persona a trasladar/custodiar:" 
                            v-model='personatrasladarcustodiar' 
                            v-validate="'required'" 
                            :error-messages="errors.collect('persona a trasladar/custodiar')"
                        ></v-text-field>
  ...
  export default {
    ...
    data: () => ({
        ...
        headers: [
            ...
            { text: 'Persona a trasladar/custodiar', value: 'personaaTras' },
           ...
           this.$validator.validate().then(result => {
                    if (result) { 
                            ...
                            me.$PI.post('api/TrasladoYCustodias/Crear',{  
                                ...
                                'Juzgado' :me.juzgado,
                                'PersonaaTras' :me.personatrasladarcustodiar,
                                'Lugar': me.lugar,
                                'Hora' :me.hora,
                                'fecha' :me.dia,
