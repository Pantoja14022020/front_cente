    ...
    <n403 v-if="e403" />
      <v-flex v-if="showpage">
        <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Requerimientos Varios</v-toolbar-title>
        ...
        <v-dialog v-model="dialogo" fullscreen hide-overlay transition="dialog-bottom-transition">
            ...
            <v-toolbar dark color="primary">
                ...
                <v-toolbar-title>Registrar requerimiento</v-toolbar-title>
                <v-spacer></v-spacer>
                <v-toolbar-items>
            ...
            <v-container grid-list-md text-xs-center>
                <v-layout row wrap>
                    ...
                    <v-flex class="espaciado" xs12 sm12 md12 lg12 >
                        <v-card elevation="0" >
                            <v-card-title class="accent"><h3>Descipción</h3></v-card-title>
                                    <v-card-text>
                                        <vue-editor  
                                            name="descripcion"                                        
                                            v-model="descripcion" 
