    ...
    <n403 v-if="e403" />
      <v-flex v-if="showpage">
        <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Asignación de Presentaciones y Comparecencias </v-toolbar-title>
  ...
  export default {
    ...
    methods:{ 
        ...
        listarModulos(item){ 
            ...
            let header={"Authorization" : "Bearer " + this.$store.state.token};
            let configuracion= {headers : header};
            me.idpres  = item.idPresentacionesYC;
        ...
        asignarunidad(){
            ...
            if (result) {
              me.$PI.put('api/PresentacionYC/AsiganarUnidad',{
                    'IdPresentacionesYC': me.idpres,
