    ...
    <n403 v-if="e403" />
      <v-flex v-if="showpage">
        <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Busqueda de Domicilio</v-toolbar-title>
        ...
        <v-dialog v-model="dialogo" fullscreen hide-overlay transition="dialog-bottom-transition">
            ...
            <v-toolbar dark color="primary">
                ...
                <v-toolbar-title>Busqueda de Domicilio</v-toolbar-title>
                <v-spacer></v-spacer>
                <v-toolbar-items>
  ...
  export default {
    ...
    data: () => ({
        ...
        headers: [
            ...
            { text: 'Causa Penal/Expediente', value: 'Causapenal' },
