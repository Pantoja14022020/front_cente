    ...
    <n403 v-if="e403" />
      <v-flex v-if="showpage">
        <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Presentaciones y Comparecencias</v-toolbar-title>
        ...
        <v-dialog v-model="dialogo" fullscreen hide-overlay transition="dialog-bottom-transition">
            ...
            <v-toolbar dark color="primary">
                ...
                <v-toolbar-title>Registrar presentación o comparecencia</v-toolbar-title>
                <v-spacer></v-spacer>
                <v-toolbar-items>
                ...
                <v-layout row wrap>
                    <v-flex class="espaciado" xs12 sm12 md6 lg6 >
                        ...
                        <v-text-field 
                            ...
                            v-model='recepcion' 
                            v-validate="'required'" 
                            :error-messages="errors.collect('recepcion')"
                        ></v-text-field>
                        ...
                        <v-menu
                            ...
                            :return-value.sync="fechapresentacion"
                        ...
                        >
                            ...
                            ></v-text-field>
                                ...
                                <v-date-picker locale="es" v-model="fechapresentacion" no-title scrollable>
                                <v-spacer></v-spacer>
                    ...
                    <v-flex class="espaciado" xs12 sm12 md6 lg6 >
                        ...
                        <v-text-field 
                            name="persona a presentar"
                            label="*Persona a presentar:" 
                            v-model='personapresentar' 
                            v-validate="'required'" 
                            :error-messages="errors.collect('persona a presentar')"
                        ></v-text-field>
                        ...
                        <v-text-field 
                            ...
                            v-model='asignado' 
                            v-validate="'required'" 
                            :error-messages="errors.collect('asignado')"
                        ></v-text-field>


                        <v-text-field 
                            name="cumplida o informada"
                            label="*Cumplida o informada:" 
                            v-model='cumplidainformada' 
                            v-validate="'required'" 
                            :error-messages="errors.collect('cumplida o informada')"
                        ></v-text-field>
  ...
  export default {
    ...
    methods:{ 
           ...
           this.$validator.validate().then(result => {
                    if (result) { 
                            ...
                            me.$PI.post('api/PresentacionYC/Crear',{  
                                ...
                                'Dependencia' :me.dependencia,
                                'PerAPresentar' :me.personapresentar,
                                'FdePresentacion':me.fechap,
                                'Hora' :me.hora,
                                'Asignado' :me.asignado,
                                'CumplidaOInf' :me.cumplidainformada,
                                'Status' :"Solicitado",
                                'Estado' :"Creado",
                                'Respuesta' :"",
        ...
        fechainif(){
            if(this.menu1){
                this.generarfecha2();
            this.$refs.menu1.save(this.fechapresentacion);
            }    
            if(this.menu22){
                this.generarfecha2();
        ...
        generarfecha2(){           
            if(this.menu1) 
            this.fechap =this.fechapresentacion.substring(8,10) +" de "+ this.obtenermes(this.fechapresentacion.substring(5,7)-1)+
            " del "+ this.fechapresentacion.substring(0,4); 
