...
/////////////////////////////////////////////////////////////////////////////
                 ...
                 for(var i=0;i<me.meses.length;i++){
                                      
                    if(registro.ultmimoStatus.substring(5,7) == me.meses[i].value){
                       
                        for(var j=0;j<me.registros.length;j++){
                            
                            if(me.registros[j].mes == me.meses[i].mes )  {
                                estado = true;
                                if(registro.statusAC == 'Finalizado')
                        ...
                        if(estado == false){                               
                                me.registros.push({mes: me.meses[i].mes, asignado:0,enproceso:0,finalizado:0,suspendido:0,pospuesto:0,entregado:0,total:0,mesno:me.meses[i].value});
                                    if(registro.statusAC == 'Finalizado')
                                    me.registros[j].finalizado++
                                    else if(registro.statusAC =='Asignado')
                                        me.registros[j].asignado ++
