    ...
    <n403 v-if="e403" />
      <v-flex v-if="showpage">
        <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Asignación de Arrestos</v-toolbar-title>
  ...
  export default {
    ...
    methods:{ 
        ...
        asignarunidad(){
            ...
            if (result) {
            axios.put('api/Arresto/AsiganarUnidad',{
                    'IdArresto': me.idarrestos,
