    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Tipo de Vehiculos.</v-toolbar-title>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Modelo', value: 'dato', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo Tipo' : 'Actualizar Tipo'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.idTipov= item.idTipov;
                this.tipov=item.dato;  
                this.editedIndex=1;
                this.dialog = true
            },
            close () {
