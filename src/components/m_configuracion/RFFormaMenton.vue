    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Forma de mentón</v-toolbar-title>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Forma de mentón', value: 'tipo', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo dato de Forma de mentón' : 'Actualizar Forma de mentón'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.idRepresentante= item.idFormaMenton;
