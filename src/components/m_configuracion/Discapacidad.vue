      ...
      <NavDrawer></NavDrawer>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Discapacidad.</v-toolbar-title>
...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nueva discapacidad' : 'Actualizar discapacidad'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.idDiscapacidad= item.idDiscapacidad;
