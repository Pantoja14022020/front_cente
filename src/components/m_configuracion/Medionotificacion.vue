    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Medios de notificación.</v-toolbar-title>
...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo medio de notificación' : 'Actualizar medio de notificación'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.idMedioNotificacion= item.idMedioNotificacion;
