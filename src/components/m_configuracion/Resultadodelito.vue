...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo tipo de resultado del delito' : 'Actualizar tipo de resultado del delito'
            },
              formIcon () {
        ...
        methods:{
            listar(){
                ...
                this.$conf.get('api/ResultadoDelitoes/Listar',configuracion).then(function(response){
            ...
            editItem (item) {
                this.idResultadoDelito= item.idResultadoDelito; 
                ...
                this.$validator.validate().then(result => {
                    if (result) { 
                        if (this.editedIndex > -1) {
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.put('api/ResultadoDelitoes/Actualizar',{
                                'idResultadoDelito':me.idResultadoDelito, 
                                'nombre': me.nombre 
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.post('api/ResultadoDelitoes/Crear',{
                                'nombre': me.nombre 
                            },configuracion).then(function(response){
                                me.close();
