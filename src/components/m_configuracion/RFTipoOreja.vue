    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Tamaño de orejas</v-toolbar-title>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Tamaño de orejas', value: 'tipo', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo dato de Tamaño de orejas' : 'Actualizar Tamaño de orejas'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.idRepresentante= item.idTipoOrejas;
