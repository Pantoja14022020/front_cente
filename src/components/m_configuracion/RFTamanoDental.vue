    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Tamaño dental</v-toolbar-title>
                                ...
                                <v-container grid-list-md>
                                    <v-layout wrap>
                                        <v-flex xs12 sm12 md12>
                                            <v-text-field name="Tamaño dental" 
                                                label="Tamaño dental:"
                                                v-model="dato" 
                                                v-validate="'required'"
                                                :error-messages="errors.collect('Tamaño dental')">
                                            </v-text-field>
                                        </v-flex>
                                    </v-layout>
                                </v-container>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Tamaño dental', value: 'dato', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo dato de Tamaño dental' : 'Actualizar dato de Tamaño dental'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.iddato= item.idTamano_Dental;
                this.dato=item.dato;  
                this.editedIndex=1;
                this.dialog = true
            },
