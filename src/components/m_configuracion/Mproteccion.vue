                                ...
                                <v-container grid-list-md>
                                    <v-layout wrap>
                                        <v-flex xs12 sm12 md12>
                                            ...
                                            <v-text-field name="medida de protección" 
                                                label="Medida de protección:"
                                                v-model="mproteccion" 
                                                v-validate="'required'"
                                                :error-messages="errors.collect('medida de protección')">
                                            </v-text-field>
                                        </v-flex>
                                    </v-layout>
                                </v-container>
...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nueva medida de protección' : 'Actualizar medida de protección'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.IdMedidasProteccionC= item.idMedidasProteccionC;
                this.clasificacion=item.clasificacion;  
                this.clave =item.clave; 
                this.mproteccion = item.descripcion;
                this.editedIndex=1;
                this.dialog = true
            },
