    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Calibres de Armas</v-toolbar-title>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Calibre', value: 'numero', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo calibre' : 'Actualizar calibre'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.IdCalibre = item.idCalibre;
                this.calibre = item.numero;
                this.editedIndex=1;
                this.dialog = true
            },
