    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Tipo de menton</v-toolbar-title>
                                ...
                                <v-container grid-list-md>
                                    <v-layout wrap>
                                        <v-flex xs12 sm12 md12>
                                            <v-text-field name="Tipo de menton" 
                                                label="Tipo de menton:"
                                                v-model="dato" 
                                                v-validate="'required'"
                                                :error-messages="errors.collect('Tipo de menton')">
                                            </v-text-field>
                                        </v-flex>
                                    </v-layout>
                                </v-container>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Tipo de menton', value: 'dato', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo dato de Tipo de menton' : 'Actualizar dato de Tipo de menton'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.iddato= item.idTipo_de_Menton;
                this.dato=item.dato;  
                this.editedIndex=1;
                this.dialog = true
            },
