    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Color de cabello</v-toolbar-title>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Color de cabello', value: 'tipo', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo dato de Color de cabello' : 'Actualizar Color de cabello'
            },
              formIcon () {
        ...
        methods:{
            listar(){
                ...
                this.$conf.get('api/Color_de_Cabellos/Listar',configuracion).then(function(response){
            ...
            editItem (item) {
                this.idRepresentante= item.idColorCabello;
                ...
                this.$validator.validate().then(result => {
                    if (result) {
                        if (this.editedIndex > -1) {
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.put('api/Color_de_Cabellos/Actualizar',{
                                'IdColorCabello':me.idRepresentante, 
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.post('api/Color_de_Cabellos/Crear',{
                                'Dato': me.representante, 
                            },configuracion).then(function(response){
                                me.close();
