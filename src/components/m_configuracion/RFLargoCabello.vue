    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Longitud de Cabello</v-toolbar-title>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Longitud de Cabello', value: 'tipo', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo dato Longitud de Cabello' : 'Actualizar  Longitud de Cabello'
            },
              formIcon () {
        ...
        methods:{
            listar(){
                ...
                this.$conf.get('api/Largo_de_Cabello/Listar',configuracion).then(function(response){
            ...
            editItem (item) {
                this.idRepresentante= item.idLargoCabello;
                ...
                this.$validator.validate().then(result => {
                    if (result) {
                        if (this.editedIndex > -1) {
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.put('api/Largo_de_Cabello/Actualizar',{
                                'IdLargoCabello':me.idRepresentante, 
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.post('api/Largo_de_Cabello/Crear',{
                                'Dato': me.representante, 
                            },configuracion).then(function(response){
                                me.close();
