    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Modelo Vehiculo.</v-toolbar-title>
    ...
    export default {
        ...
        data(){
            return {             
                dialog: false,
                headers: [
                    { text: 'Nombre', value: 'dato', sortable: true } ,   
                    { text: 'Marca', value: 'nombreMarca', sortable: true },
        ...
        methods:{
            ...
            editItem (item) {
                this.idmodelo =item.idModelo;
                this.modelo = item.dato;
                this.marca = item.marcaId;                
                this.editedIndex=1;
                this.dialog = true
            },
