      ...
      <NavDrawer></NavDrawer>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Complexión</v-toolbar-title>
...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo dato de  tipo Complexión' : 'Actualizar  tipo de Complexión'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.idRepresentante= item.idComplexion;
