    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Status de carpeta.</v-toolbar-title>
...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo status de carpeta' : 'Actualizar status de carpeta'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.idStatusNuc= item.idStatusNuc; 
                this.etapa= item.etapa; 
                this.nombreStatus=item.nombreStatus; 
                this.editedIndex=1;
                this.dialog = true
            },
