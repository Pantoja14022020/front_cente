    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Localidad.</v-toolbar-title> 
            ...
            <v-layout >
               ...
               <v-data-table
                ...
                <template slot="items" class="white" slot-scope="props">
                    ...
                    <td>{{ props.item.nombreMunicipio }}</td> 
...
<script>
    ...
    export default {
        ...
        data(){
            return {
                ...
                headers: [
                    ...
                    { text: 'Municipio', value: 'nombreMunicipio' },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nueva localidad' : 'Actualizar localidad'
            },
            formIcon () {
        ...
        methods:{
            ...
            editItem (item) {   
                this.idLocalidad = item.idLocalidad;  
