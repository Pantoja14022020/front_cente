    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Cantidad de Cabello</v-toolbar-title>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Cantidad de Cabello', value: 'tipo', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo dato de Cantidad de Cabello' : 'Actualizar dato de Cantidad de Cabello'
            },
              formIcon () {
        ...
        methods:{
            listar(){
                ...
                this.$conf.get('api/Cantidad_de_cabello/Listar',configuracion).then(function(response){
            ...
            editItem (item) {
                this.idRepresentante= item.idCantidadCabello;
                ...
                this.$validator.validate().then(result => {
                    if (result) {
                        if (this.editedIndex > -1) {
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.put('api/Cantidad_de_cabello/Actualizar',{
                                'IdCantidadCabello':me.idRepresentante, 
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.post('api/Cantidad_de_cabello/Crear',{
                                'Dato': me.representante, 
                            },configuracion).then(function(response){
                                me.close();
