    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Tipo de dentadura</v-toolbar-title>
                                ...
                                <v-container grid-list-md>
                                    <v-layout wrap>
                                        <v-flex xs12 sm12 md12>
                                            <v-text-field name="Tipo de dentadura" 
                                                label="Tipo de dentadura:"
                                                v-model="dato" 
                                                v-validate="'required'"
                                                :error-messages="errors.collect('Tipo de dentadura')">
                                            </v-text-field>
                                        </v-flex>
                                    </v-layout>
                                </v-container>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Tipo de dentadura', value: 'dato', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo dato de Tipo de dentadura' : 'Actualizar dato de Tipo de dentadura'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.iddato= item.idTipo_Dentadura;
                this.dato=item.dato;  
                this.editedIndex=1;
                this.dialog = true
            },
