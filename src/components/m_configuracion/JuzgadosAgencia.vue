      ...
      <NavDrawer></NavDrawer>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Juzgados-Agencias</v-toolbar-title>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Nombre', value: 'multa' }, 
                    { text: 'Direccion', value: 'multa' },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nueva Multa de Citatorio' : 'Actualizar Multa de Citatorio'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.idMultaCitatorio= item.idMultaCitatorio;
                this.multa=item.dato;
                ...
                this.$validator.validate().then(result => {
                    if (result) {
                        if (this.editedIndex > -1) {
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.put('api/JuzgadosAgencia/Crear',{
