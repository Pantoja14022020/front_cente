    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Estado.</v-toolbar-title>
                          ...
                          <v-form ref="form">
                                <v-container grid-list-md>
                                   ...
                                   <v-flex xs12 sm12 md12>
                                        ...
                                        <v-flex xs12 sm12 md12>
                                            <v-text-field name="abreviacion" 
                                                          label="Abreviacion RENAPO:"
                                                          v-model="abreviacion" 
                                                          v-validate="'required'"
                                                          :error-messages="errors.collect('abreviacion')">
                                            </v-text-field>
                                        </v-flex>
    ...
    export default {
        ...
        data(){
            return {
                ...
                headers: [
                    ...
                    { text: 'Abreviacion RENAPO', value: 'abreviacion' },
        ...
        methods:{
            ...
            editItem (item) {
                ...
                this.abreviacion= item.abreviacion;
                this.editedIndex=1;
                this.dialog = true
            },
