    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Tipo de fuero.</v-toolbar-title>
...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo tipo de fuero' : 'Actualizar tipo fuero'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.idTipoFuero= item.idTipoFuero; 
