      ...
      <NavDrawer></NavDrawer>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Clasificacíon de Armas</v-toolbar-title>
                          ...
                          <v-form ref="form">
                                <v-container grid-list-md>
                                    ...
                                    <v-flex xs12 sm12 md12>
                                         ...
                                         <v-text-field name="clasificacíon" 
                                                          label="Clasificacíon"
                                         ...
                                         <v-switch 
                                            v-model="catalogo"
                                            :label="`Maneja Catalogo: ${textosino}`"
                                            color="success"
                                            ></v-switch>
                                    </v-flex>
            ...
            <v-data-table
                ...
                <template slot="items" class="white" slot-scope="props">
                    ...
                    <td>{{ props.item.nombreC }}</td> 
                    <td>
                         <div v-if="props.item.catalogo">
    ...
    export default {
        ...
        data(){
            return {             
                dialog: false,
                headers: [
                    { text: 'Nombre', value: 'nombreC', sortable: true },
                    { text: 'Catalogo', value: 'catalogo', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nueva Clasificacíon' : 'Actualizar Clasificacíon'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.idClasificacion= item.idClasificacionArma;
                this.clasificacion=item.nombreC;  
