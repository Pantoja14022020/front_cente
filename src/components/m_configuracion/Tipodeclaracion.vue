    ...
    export default {
        ...
        methods:{
            listar(){
                ...
                axios.get('api/TipoDeclaracions/Listar',configuracion).then(function(response){ 
                ...
                this.$validator.validate().then(result => {
                    if (result) { 
                        if (this.editedIndex > -1) {
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            axios.put('api/TipoDeclaracions/Actualizar',{
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            axios.post('api/TipoDeclaracions/Crear',{ 
                                'nombre': me.nombre 
                            },configuracion).then(function(response){
                                me.close();
