...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo tipo de declaración' : 'Actualizar tipo declaración'
            },
              formIcon () {
        ...
        methods:{
            listar(){
                ...
                this.$conf.get('api/TipoDeclaracions/Listar',configuracion).then(function(response){
            ...
            editItem (item) {
                this.idTipoDeclaracion= item.idTipoDeclaracion; 
                ...
                this.$validator.validate().then(result => {
                    if (result) { 
                        if (this.editedIndex > -1) {
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.put('api/TipoDeclaracions/Actualizar',{
                                'idTipoDeclaracion':me.idTipoDeclaracion, 
                                'nombre': me.nombre 
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.post('api/TipoDeclaracions/Crear',{
                                'nombre': me.nombre 
                            },configuracion).then(function(response){
                                me.close();
