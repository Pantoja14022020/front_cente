    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Tamaño de nariz</v-toolbar-title>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Tamaño de nariz', value: 'tipo', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo dato de Tamaño de nariz' : 'Actualizar Tamaño de nariz'
            },
              formIcon () {
        ...
        methods:{
            listar(){
                ...
                this.$conf.get('api/Tamaño_Nariz/Listar',configuracion).then(function(response){
            ...
            editItem (item) {
                this.idRepresentante= item.idTamañoNariz;
                ...
                this.$validator.validate().then(result => {
                    if (result) {
                        if (this.editedIndex > -1) {
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.put('api/Tamaño_Nariz/Actualizar',{
                                'IdTamañoNariz':me.idRepresentante, 
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.post('api/Tamaño_Nariz/Crear',{
                                'Dato': me.representante, 
                            },configuracion).then(function(response){
                                me.close();
