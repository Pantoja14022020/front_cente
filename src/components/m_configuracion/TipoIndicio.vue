    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Tipos Indicios.</v-toolbar-title>
...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo indicio' : 'Actualizar indicio'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.idTipoIndicio= item.idTipoIndicio;
