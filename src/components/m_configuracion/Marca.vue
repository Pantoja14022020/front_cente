    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Marca de Vehiculos.</v-toolbar-title>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Marca', value: 'dato', sortable: true },
        ...
        methods:{
            listar(){
                ...
                this.$conf.get('api/Marca/Listar',configuracion).then(function(response){
                ...
                this.$validator.validate().then(result => {
                    if (result) {
                        if (this.editedIndex > -1) {
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.put('api/Marca/Actualizar',{
                                'idMarca':me.idMarca, 
                                'dato': me.marca
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.post('api/Marca/Crear',{
                                'dato': me.marca, 
                            },configuracion).then(function(response){
                                me.close();
