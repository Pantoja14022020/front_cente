    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Nacionalidad.</v-toolbar-title>
...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nueva nacionalidad' : 'Actualizar nacionalidad'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.idNacionalidad= item.idNacionalidad;
