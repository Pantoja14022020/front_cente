    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Tratamiento dental</v-toolbar-title>
                                ...
                                <v-container grid-list-md>
                                    <v-layout wrap>
                                        <v-flex xs12 sm12 md12>
                                            <v-text-field name="Tratamiento dental" 
                                                label="Tratamiento dental:"
                                                v-model="dato" 
                                                v-validate="'required'"
                                                :error-messages="errors.collect('Tratamiento dental')">
                                            </v-text-field>
                                        </v-flex>
                                    </v-layout>
                                </v-container>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Tratamiento dental', value: 'dato', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo dato de Tratamiento dental' : 'Actualizar dato de Tratamiento dental'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.iddato= item.idTratamiento_Dental;
                this.dato=item.dato;  
                this.editedIndex=1;
                this.dialog = true
            },
