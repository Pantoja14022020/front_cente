    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Tamaño de Ojos</v-toolbar-title>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Tamaño de Ojos', value: 'tipo', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo dato de Tamaño de Ojos' : 'Actualizar Tamaño de Ojos'
            },
              formIcon () {
        ...
        methods:{
            listar(){
                ...
                this.$conf.get('api/TipoOjos/Listar',configuracion).then(function(response){
            ...
            editItem (item) {
                this.idRepresentante= item.idTipoOjos;
                ...
                this.$validator.validate().then(result => {
                    if (result) {
                        if (this.editedIndex > -1) {
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.put('api/TipoOjos/Actualizar',{
                                'IdTipoOjos':me.idRepresentante, 
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.post('api/TipoOjos/Crear',{
                                'Dato': me.representante, 
                            },configuracion).then(function(response){
                                me.close();
