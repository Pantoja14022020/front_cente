      ...
      <NavDrawer></NavDrawer>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Municipio.</v-toolbar-title>
...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo municipio' : 'Actualizar municipio'
            },
            formIcon () {
        ...
        methods:{
            ...
            editItem (item) {  
                this.idMunicipio = item.idMunicipio;
