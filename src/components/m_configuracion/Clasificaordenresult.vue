    ...
    <v-layout align-start>
         ...
         <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Clasificación del delito en orden al resultado.</v-toolbar-title>
...
<script>
    ...
    export default {
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo clasificacion del delito en orden al resultado' : 'Actualizar clasificacion del delito en orden al resultado'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.idClasificaOrdenResult= item.idClasificaOrdenResult; 
