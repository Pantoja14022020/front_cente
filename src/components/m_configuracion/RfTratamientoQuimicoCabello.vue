    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Tratamiento químico de cabello</v-toolbar-title>
                                ...
                                <v-container grid-list-md>
                                    <v-layout wrap>
                                        <v-flex xs12 sm12 md12>
                                            <v-text-field name="Tratamiento químico de cabello" 
                                                label="Tratamiento químico de cabello:"
                                                v-model="dato" 
                                                v-validate="'required'"
                                                :error-messages="errors.collect('Tratamiento químico de cabello')">
                                            </v-text-field>
                                        </v-flex>
                                    </v-layout>
                                </v-container>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Tratamiento químico de cabello', value: 'dato', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo dato de Tratamiento químico de cabello' : 'Actualizar dato de Tratamiento químico de cabello'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.iddato= item.idTratamientos_Quimicos_Cabello;
                this.dato=item.dato;  
                this.editedIndex=1;
                this.dialog = true
            },
