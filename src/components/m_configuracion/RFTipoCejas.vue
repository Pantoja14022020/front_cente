    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Implantación de Cejas</v-toolbar-title>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Implantación de Cejas', value: 'tipo', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo dato de Implantación de Cejas' : 'Actualizar Implantación de Cejas'
            },
              formIcon () {
        ...
        methods:{
            ...
            editItem (item) {
                this.idRepresentante= item.idFormaCejas;
