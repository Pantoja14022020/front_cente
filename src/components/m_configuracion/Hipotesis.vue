    ...
    <v-layout align-start>
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Catalogo Hipótesis</v-toolbar-title>
    ...
    export default {
        ...
        data(){
            return {
                ...
                dialog: false,
                headers: [
                    { text: 'Tipo de Complexión', value: 'tipo', sortable: true },
        ...
        computed: {
            formTitle () {
                return this.editedIndex === -1 ? 'Nuevo dato de Hipótesis' : 'Actualizar Hipótesis'
            },
              formIcon () {
        ...
        methods:{
            listar(){
                ...
                this.$conf.get('api/Hipotesis/Listar',configuracion).then(function(response){
            ...
            editItem (item) {
                this.idRepresentante= item.idHipotesis;
                ...
                this.$validator.validate().then(result => {
                    if (result) {
                        if (this.editedIndex > -1) {
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.put('api/Hipotesis/Actualizar',{
                                'IdHipotesis':me.idRepresentante, 
                            ...
                            let header={"Authorization" : "Bearer " + this.$store.state.token};
                            let configuracion= {headers : header};
                            this.$conf.post('api/Hipotesis/Crear',{
                                'Dato': me.representante, 
                            },configuracion).then(function(response){
                                me.close();
