    ...
    <n403 v-if="e403" />
      <v-flex v-if="showpage">
        <v-toolbar flat color="white">
                    <v-toolbar-title class="font-weight-regular" >Solicitudes sin registro 
</v-toolbar-title>
  ...
  export default {
    ...
    data: () => ({
        ...
        headers: [
            ...
            { text: 'Estatus', value: 'statusRespuesta' , sortable:false},
    ...
    methods:{ 
        ...
        listar(){
          ...
          let configuracion= {headers : header};
                me.$PI.get('api/CMedicoPSR/ListarTodos',configuracion).then(function(response){
        ...
        listarModulos(item){ 
            ...
            let header={"Authorization" : "Bearer " + this.$store.state.token};
            let configuracion= {headers : header};
            me.rDiligenciasId = item.idCMedicoPSR;
        ...
        asignarunidad(){
            ...
            if (result) { 
                    ...
                    me.$PI.put('api/CMedicoPSR/AsignarModuloServicio',{
                        'IdCMedicoPSR': me.rDiligenciasId,
        ...
        RechazarSoli(){
            ...
            if (result) { 
                    ...
                    me.$PI.put('api/CMedicoPSR/RechazarSolicitudServicio',{
                        'IdCMedicoPSR': me.rDiligenciasId,
