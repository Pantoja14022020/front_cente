            ...
            if (result) {   
                ...
                me.$SP.get('api/PeritoAsignado/Listarporidfecha/'+me.u_iddsp+'/'+ me.fechaInicio +" 00:00:00"+'/'+me.fechaFin+" 23:59:59",configuracion).then(function(response){
                    ...
                    me.$SP.get('api/PeritoAsignado/PorModulo/'+me.u_iddsp+'/'+ me.fechaInicio +" 00:00:00"+'/'+me.fechaFin+" 23:59:59",configuracion).then(function(response){
                        ...
                        me.$SP.get('api/PeritoAsignado/PorAño/'+me.u_iddsp+'/'+ me.fechaInicio +" 00:00:00"+'/'+me.fechaFin+" 23:59:59",configuracion).then(function(response){
                                me.peritosasignadosfecha=response.data;
                                    ...
                                    me.mesmostrar = me.obtenermes(me.fechaInicio.substring(5,7)-1) + " "+me.fechaInicio.substring(0,4) +" a "+  me.obtenermes(me.fechaFin.substring(5,7)-1) + " "+me.fechaFin.substring(0,4)
                                    ...
                                    me.peritosasignadosfecha.push({fechas: 'Total',finalizado:fin,asignado: asig,enproceso: enpro,suspendido: sus,pospuesto: pos,entregado: ent,total:total });
                                    ...
                                    for(var i=0;i<me.peritosasignadosfecha.length-1;i++){
                                        me.crear2();
                                        me.graficarindividual(me.peritosasignadosfecha[i].fechas,me.peritosasignadosfecha[i].finalizado,me.peritosasignadosfecha[i].asignado,me.peritosasignadosfecha[i].enproceso,me.peritosasignadosfecha[i].suspendido,me.peritosasignadosfecha[i].pospuesto,me.peritosasignadosfecha[i].entregado);
                                        me.conteograficas++;
                                    }
