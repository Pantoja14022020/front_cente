  ...
  export default {
    ...
    created () {
        ...
        let me = this 
                ...
                me.u_clavedistrito = me.$store.state.usuario.iddistrito;
    ...
    methods:{ 
      ...
      axios.get('api/PeritoAsignadoForaneas/ListarporrdiligenciasForaneas/'+me.u_rdiligenciaF ,configuracion).then(function(response){
        ...
        listar(){
          ...
          let header={"Authorization" : "Bearer " + this.$store.state.token};
          let configuracion= {headers : header};
          console.log(me.u_clavedistrito)
                me.$CAT.get('api/RDiligenciasForaneas/Listarporagencia/'+me.u_idagencia+"/"+ me.u_clavedistrito, configuracion).then(function(response){
        ...
        listarModulos(item){ 
            ...
            me.rDiligenciasId = item.idRDiligenciasForaneas;
            me.agenciaenvia = item.agenciaEnvia;
            console.log("aadasd"+item.agenciaEnvia)
        ...
        asignarperito(){
            ...
            if (result) { 
                if(this.editedIndex == -1){
                    ...
                    me.$CAT.put('api/RDiligenciasForaneas/Actualizarstatus2',{
                        'idRDiligenciasForaneas': me.rDiligenciasId,
                        'statusRespuesta': "Rechazado",
                        'respuestas':textorechazado

                    },configuracion).then(function(ressponse){                            
                        me.$notify('La información se actualizo correctamente !!!','success')
                        
                        me.$CAT.put('api/RDiligenciasForaneas/Actualizarstatus2Foraneas',{
                        'idRDiligenciasForaneas': me.rDiligenciasId,
                        'statusRespuesta': "Rechazado",
                        'respuestas':textorechazado,
                        'AgenciaEnvia': me.agenciaenvia
