      ...
      <v-flex v-if="showpage">
        ...
        <v-data-table
                ...
                <template slot="items" class="white" slot-scope="props">
                    ...
                    <td>{{ props.item.agenciaPericial }}</td>
  ...
  export default {
    ...
    data: () => ({
        ...
        headers: [
            ...
            { text: 'Especialidad', value: 'espacialidad' },
    ...
    methods:{
        ...
        listar(){
            ...
            console.log(me.u_iddsp)
            console.log(me.u_iddistrito)
            me.$CAT.get('api/RDiligencias/ListarTodos/' + me.u_iddsp + '/' + me.u_iddistrito , configuracion).then(function(response){
        ...
        RecibirFisicamente(item){
            ...
            me.$CAT.put('api/RDiligencias/ActualizarfechaR',{
                    'idRDiligencias': item.idRDiligencias,
