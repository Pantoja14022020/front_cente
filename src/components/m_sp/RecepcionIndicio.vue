      ...
      <v-list-tile
        ...
        <v-flex v-if="showpage">
            <v-toolbar flat color="white">
                <v-toolbar-title class="font-weight-regular" >Recepcion de indicio</v-toolbar-title>   
                        ...
                        <td class="justify-center layout px-0">
                            <v-tooltip bottom>
                                <template v-slot:activator="{ on }">
                                    <v-icon  class="mr-2" v-on="on" @click="listarIndicios(props.item)">
                                        add
                                    </v-icon> 
                                </template>
                            ...
                            <v-tooltip bottom>
                                <template v-slot:activator="{ on }">
                                    <v-icon class="mr-2" v-on="on" @click="VerDetallesIndicios(props.item)">
                                        assignment
                                    </v-icon> 
                                </template>
                                    ...
                                    <v-flex class="espaciado" xs12 sm12 md6 lg6>
                                        <v-list two-line>
                                            <v-list-tile>  
                                                ...
                                                <v-list-tile-content>  
                                                    <v-list-tile-title>
                                                        <p class="body-2 font-weight-bold"><a>Lugar de origen:</a></p>
                                                    </v-list-tile-title> 
                                                    <v-list-tile-sub-title>
                                                        <p color="accent" class="caption font-weight-regular"><a>{{ detalle.lo }}</a></p>  
                                                    </v-list-tile-sub-title>  
                                                </v-list-tile-content> 
                                            </v-list-tile>
                                            <v-list-tile>  
                                                ...
                                                <v-list-tile-content>  
                                                    <v-list-tile-title> 
                                                        <p class="body-2 font-weight-bold"><a>Lugar de destino:</a></p> 
                                                    </v-list-tile-title> 
                                                    <v-list-tile-sub-title> 
                                                        <p color="accent" class="caption font-weight-regular"><a>{{ detalle.ld }}</a></p>  
                                                    </v-list-tile-sub-title>  
                                                </v-list-tile-content> 
                                            </v-list-tile>                                                                                       
                                        </v-list>
                                        ...
                                        <v-flex class="espaciado" xs12 sm12 md6 lg6>
                                            <v-list two-line>
                                                <v-list-tile>  
                                                    ...
                                                    <v-list-tile-content>  
                                                        <v-list-tile-title> 
                                                            <p class="body-2 font-weight-bold"><a>Quién entrega:</a></p> 
                                                        </v-list-tile-title> 
                                                        <v-list-tile-sub-title> 
                                                            <p color="accent" class="caption font-weight-regular"><a>{{ detalle.qe }}</a></p>  
                                                        </v-list-tile-sub-title>  
                                                    </v-list-tile-content> 
                                                </v-list-tile>
                                                <v-list-tile>  
                                                    ...
                                                    <v-list-tile-content>  
                                                        <v-list-tile-title> 
                                                            <p class="body-2 font-weight-bold"><a>Quién recibe:</a></p> 
                                                        </v-list-tile-title> 
                                                        <v-list-tile-sub-title> 
                                                            <p color="accent" class="caption font-weight-regular"><a>{{ detalle.qr }}</a></p>
                                                        </v-list-tile-sub-title>  
                                                    </v-list-tile-content> 
                                                </v-list-tile>                                                                                    
                                            </v-list>
...
<script> 
  ...
  export default {
    ...
    computed: {
        formTitle () {
                return this.indiciosd === -1 ? 'Agregar detalle de indicio' : 'Lista de detalles del indicio'
            },
      formIcon () {
